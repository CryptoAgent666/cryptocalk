...
const LOCALIZED_SPEC_SLUGS: Record<Exclude<Lang, 'en'>, Record<SpecCalculatorSlug, string>> = {
    es: {
        ...
        'mayer-multiple-calculator': 'calculadora-multiplo-mayer',
        'geometric-mean-return-calculator': 'calculadora-media-geometrica-retorno',
        'mstr-mnav-calculator': 'calculadora-mnav-mstr',
        'lightning-network-fee-calculator': 'calculadora-comisiones-lightning',
        'pumpfun-bonding-curve-calculator': 'calculadora-curva-pumpfun',
        'profit-factor-calculator': 'calculadora-factor-beneficio',
        'covered-call-calculator': 'calculadora-call-cubierta',
        'iron-condor-calculator': 'calculadora-iron-condor',
        'perpetual-funding-arbitrage-calculator': 'calculadora-arbitraje-funding-perpetuo',
        'concentrated-liquidity-calculator': 'calculadora-liquidez-concentrada',
        'looping-yield-calculator': 'calculadora-rendimiento-looping',
        'depin-earnings-calculator': 'calculadora-ingresos-depin',
        'lp-value-calculator': 'calculadora-valor-lp',
        'trailing-stop-loss-calculator': 'calculadora-trailing-stop-loss',
        'rwa-yield-calculator': 'calculadora-rendimiento-rwa',
        'polymarket-odds-calculator': 'calculadora-cuotas-polymarket',
        'crypto-card-cashback-calculator': 'calculadora-cashback-tarjeta-cripto',
        'mining-coin-switcher-calculator': 'calculadora-cambio-moneda-mineria',
        'ai-token-sector-calculator': 'calculadora-sector-tokens-ia',
        'wallet-net-worth-calculator': 'calculadora-patrimonio-wallet',
    },
    pt: {
        'converter': 'conversor-cripto',
        ...
        'geometric-mean-return-calculator': 'calculadora-media-geometrica-retorno',
        'mstr-mnav-calculator': 'calculadora-mnav-mstr',
        'lightning-network-fee-calculator': 'calculadora-taxa-lightning',
        'pumpfun-bonding-curve-calculator': 'calculadora-curva-pumpfun',
        'profit-factor-calculator': 'calculadora-fator-lucro',
        'covered-call-calculator': 'calculadora-call-coberta',
        'iron-condor-calculator': 'calculadora-iron-condor',
        'perpetual-funding-arbitrage-calculator': 'calculadora-arbitragem-funding-perpetuo',
        'concentrated-liquidity-calculator': 'calculadora-liquidez-concentrada',
        'looping-yield-calculator': 'calculadora-rendimento-looping',
        'depin-earnings-calculator': 'calculadora-rendimentos-depin',
        'lp-value-calculator': 'calculadora-valor-lp',
        'trailing-stop-loss-calculator': 'calculadora-trailing-stop-loss',
        'rwa-yield-calculator': 'calculadora-rendimento-rwa',
        'polymarket-odds-calculator': 'calculadora-odds-polymarket',
        'crypto-card-cashback-calculator': 'calculadora-cashback-cartao-cripto',
        'mining-coin-switcher-calculator': 'calculadora-troca-moeda-mineracao',
        'ai-token-sector-calculator': 'calculadora-setor-tokens-ia',
        'wallet-net-worth-calculator': 'calculadora-patrimonio-wallet',
    },
    tr: {
        ...
        'mayer-multiple-calculator': 'mayer-coklu-hesaplayici',
        'geometric-mean-return-calculator': 'geometrik-ortalama-getiri-hesaplayici',
        'mstr-mnav-calculator': 'mstr-mnav-hesaplayici',
        'lightning-network-fee-calculator': 'lightning-ucret-hesaplayici',
        'pumpfun-bonding-curve-calculator': 'pumpfun-bonding-curve-hesaplayici',
        'profit-factor-calculator': 'kar-faktoru-hesaplayici',
        'covered-call-calculator': 'kapali-call-hesaplayici',
        'iron-condor-calculator': 'iron-condor-hesaplayici',
        'perpetual-funding-arbitrage-calculator': 'perpetual-funding-arbitraj-hesaplayici',
        'concentrated-liquidity-calculator': 'yogun-likidite-hesaplayici',
        'looping-yield-calculator': 'looping-getiri-hesaplayici',
        'depin-earnings-calculator': 'depin-kazanc-hesaplayici',
        'lp-value-calculator': 'lp-deger-hesaplayici',
        'trailing-stop-loss-calculator': 'takip-eden-stop-loss-hesaplayici',
        'rwa-yield-calculator': 'rwa-getiri-hesaplayici',
        'polymarket-odds-calculator': 'polymarket-oran-hesaplayici',
        'crypto-card-cashback-calculator': 'kripto-kart-cashback-hesaplayici',
        'mining-coin-switcher-calculator': 'madencilik-coin-secici-hesaplayici',
        'ai-token-sector-calculator': 'ai-token-sektor-hesaplayici',
        'wallet-net-worth-calculator': 'cuzdan-net-deger-hesaplayici',
    },
    hi: {
        ...
        'mayer-multiple-calculator': 'mayer-multiple-calculator-hindi',
        'geometric-mean-return-calculator': 'geometric-mean-return-calculator-hindi',
        'mstr-mnav-calculator': 'mstr-mnav-calculator-hindi',
        'lightning-network-fee-calculator': 'lightning-network-fee-calculator-hindi',
        'pumpfun-bonding-curve-calculator': 'pumpfun-bonding-curve-calculator-hindi',
        'profit-factor-calculator': 'profit-factor-calculator-hindi',
        'covered-call-calculator': 'covered-call-calculator-hindi',
        'iron-condor-calculator': 'iron-condor-calculator-hindi',
        'perpetual-funding-arbitrage-calculator': 'perpetual-funding-arbitrage-calculator-hindi',
        'concentrated-liquidity-calculator': 'concentrated-liquidity-calculator-hindi',
        'looping-yield-calculator': 'looping-yield-calculator-hindi',
        'depin-earnings-calculator': 'depin-earnings-calculator-hindi',
        'lp-value-calculator': 'lp-value-calculator-hindi',
        'trailing-stop-loss-calculator': 'trailing-stop-loss-calculator-hindi',
        'rwa-yield-calculator': 'rwa-yield-calculator-hindi',
        'polymarket-odds-calculator': 'polymarket-odds-calculator-hindi',
        'crypto-card-cashback-calculator': 'crypto-card-cashback-calculator-hindi',
        'mining-coin-switcher-calculator': 'mining-coin-switcher-calculator-hindi',
        'ai-token-sector-calculator': 'ai-token-sector-calculator-hindi',
        'wallet-net-worth-calculator': 'wallet-net-worth-calculator-hindi',
    },
    ru: {
        ...
        'mayer-multiple-calculator': 'kalkulyator-koefficienta-mayera',
        'geometric-mean-return-calculator': 'kalkulyator-geometricheskoy-srednei-dohodnosti',
        'mstr-mnav-calculator': 'kalkulyator-mnav-mstr',
        'lightning-network-fee-calculator': 'kalkulyator-komissiy-lightning',
        'pumpfun-bonding-curve-calculator': 'kalkulyator-krivoy-pumpfun',
        'profit-factor-calculator': 'kalkulyator-faktora-pribyli',
        'covered-call-calculator': 'kalkulyator-pokrytogo-kolla',
        'iron-condor-calculator': 'kalkulyator-iron-condor',
        'perpetual-funding-arbitrage-calculator': 'kalkulyator-arbitrazha-fandinga-perpetuals',
        'concentrated-liquidity-calculator': 'kalkulyator-koncentrirovannoy-likvidnosti',
        'looping-yield-calculator': 'kalkulyator-looping-dohodnosti',
        'depin-earnings-calculator': 'kalkulyator-dohoda-depin',
        'lp-value-calculator': 'kalkulyator-stoimosti-lp',
        'trailing-stop-loss-calculator': 'kalkulyator-trailing-stop-loss',
        'rwa-yield-calculator': 'kalkulyator-dohodnosti-rwa',
        'polymarket-odds-calculator': 'kalkulyator-koefficientov-polymarket',
        'crypto-card-cashback-calculator': 'kalkulyator-keshbeka-kripto-karty',
        'mining-coin-switcher-calculator': 'kalkulyator-vybora-monety-mayninga',
        'ai-token-sector-calculator': 'kalkulyator-sektora-ai-tokenov',
        'wallet-net-worth-calculator': 'kalkulyator-balansa-koshelka',
    },
};
