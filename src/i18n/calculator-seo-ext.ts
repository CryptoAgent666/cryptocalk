...
export const calculatorSeoExt: Partial<Record<string, ExtContent>> = {
  ...
  'exchange-fees': {
    en: {
      interpret: ["Exchange fee analysis reveals the true cost of trading activity and helps you select the platforms and strategies that minimize friction on your returns. Exchange fees break into multiple components: maker fees (when you add liquidity via limit orders), taker fees (when you remove liquidity via market orders), withdrawal fees (fixed per-asset costs), funding rates (for perpetual futures), and spread (the difference between bid and ask). A platform advertising '0.1% trading fees' may have additional withdrawal fees of $15–$50 for certain assets that dwarf the trading fee on smaller positions.", "Comparing exchange fees requires understanding your actual trading pattern. If you primarily trade large positions infrequently, withdrawal fees matter less than taker fees. If you make many small trades, per-transaction fixed costs become dominant. VIP tiers on major exchanges significantly reduce fees for high-volume traders: Binance's fee structure drops from 0.1% to 0.015% for top-tier users — a 6.7x reduction that makes the platform's fee competitiveness entirely dependent on your trading volume."],
      scenarios: ["A trader executes 50 trades per month, average size $3,000, using taker orders. Exchange A: 0.1% taker fee = $3 per trade × 50 = $150/month. Exchange B: 0.075% taker fee = $2.25 × 50 = $112.50/month. Using a referral code reduces Exchange B by 10% = $101.25/month. Annual difference: ($150 - $101.25) × 12 = $585. The fee optimization alone adds $585 to annual returns without changing the trading strategy.", "A DeFi trader moves between CEX and DEX: CEX withdrawal fee for ETH = $8, bridge fee = $3, DEX trading fee = $1.50 (0.05% of $3,000 on a concentrated liquidity pool), plus $1 gas. Total friction per round trip = $13.50. This trader needs 0.45% price movement before any profit materializes — defining the minimum viable trade size and minimum expected return for this execution approach."],
      checklist: ["Before selecting an exchange, calculate your expected monthly fee cost using your typical trade frequency and average position size. Compare this across 3–4 platforms using each platform's published fee schedule. Include withdrawal fees by estimating monthly withdrawal frequency and the assets you typically withdraw. The lowest advertised trading fee rarely corresponds to the lowest total fee burden for your specific usage pattern.", "Evaluate available fee reduction mechanisms: trading volume discounts, native token fee discounts (BNB on Binance, FTT formerly on FTX, KCS on KuCoin), referral rebates, and maker vs. taker fee differentials. For active traders, using limit orders instead of market orders consistently can reduce fee costs by 30%–50% versus defaulting to market orders — one of the highest-ROI trading optimizations available."],
      mistakes: ["Evaluating exchange fees in isolation without considering liquidity quality. An exchange with 50% lower fees may have 1%–3% wider spreads that more than offset the fee savings, especially for larger orders. Always evaluate the combination of stated fee and effective slippage for your typical order size. Real-world execution quality often matters more than advertised fee rates.", "Neglecting funding rates for perpetual futures positions. On leveraged positions, funding rates — which can be 0.01%–0.1% every 8 hours — compound to 3%–30%+ annual costs for maintaining long positions in bull markets. For a $50,000 leveraged long, 0.05% funding every 8 hours = $25 per period × 3 per day = $75/day × 365 = $27,375 annually just in funding costs. Factor funding rates into all leveraged position calculations."],
      benchmarks: ["Leading CEX fee benchmarks (at standard tier): Binance 0.1%/0.1% maker/taker, Coinbase Pro 0.4%/0.6%, Kraken 0.16%/0.26%, Bybit 0.1%/0.1%. DEX benchmarks: Uniswap v3 0.01%–1% (pool-dependent), Curve 0.04%–0.04%, GMX 0.1%–0.2% for perpetuals. The 10x fee difference between lowest and highest CEXs represents enormous cumulative impact for active traders.", "Fee optimization impact calculation: $10,000 monthly trading volume with 0.5% average fee = $50/month = $600/year vs. the same volume at 0.1% = $10/month = $120/year. The $480 annual difference invested at 10% returns compounds to $6,200 over 10 years — demonstrating how fee optimization creates meaningful long-term wealth differences for consistent traders."],
      execution: ["Implement a tiered exchange strategy: use the highest-quality, most liquid exchange for large positions (accepting higher fees for execution quality), and lower-fee alternatives for smaller frequent trades where execution quality matters less. This bifurcated approach captures the benefits of both fee efficiency and liquidity quality without compromising either for your most important trades.", "Maximize maker order percentage. Set limit orders at your target prices rather than using market orders for non-time-sensitive entries and exits. Track your maker-to-taker ratio monthly. Moving from 20% maker to 60% maker trades typically reduces blended fee rates by 15%–25%, depending on the exchange's maker/taker differential. Some exchanges even pay rebates for maker orders, making limit order usage directly profitable."],
      hygiene: ["Track all exchange fees paid monthly as part of your portfolio performance accounting. Include CEX trading fees, withdrawal fees, DEX gas costs, bridge fees, and any subscription costs for premium features. Dividing annual fees by portfolio size gives your fee expense ratio — a metric comparable to mutual fund expense ratios. Target keeping crypto fee expense ratios below 1% of portfolio value annually.", "Review exchange fee structures quarterly. Exchanges periodically revise their fee schedules — sometimes increasing fees, sometimes adding new discount mechanisms. Setting a quarterly reminder to verify that your exchange usage pattern still aligns with the platform's optimal fee tier prevents gradually accumulating higher fees as your trading volume changes."],
      validation: ["Verify fee amounts by reconciling exchange statements against your own fee calculations. Most exchanges provide downloadable trade histories with itemized fee records. Spot-check 10 random trades per month: compare the exchange-reported fee to your manual calculation (trade size × stated fee rate). Discrepancies above 0.01% may indicate fee calculation errors, unexpected fee tier changes, or accounting for funding payments you haven't modeled.", "Test your fee optimization strategies before committing to them. Execute a small test trade using a maker limit order versus a market order on the same exchange and compare the actual fee charged. This empirical verification confirms that the fee differential you've modeled in theory actually materializes in practice — exchange fee documentation sometimes omits nuances in implementation."]
    },
    es: { interpret: ["El análisis de comisiones de intercambio revela el costo real de la actividad de negociación y te ayuda a seleccionar las plataformas y estrategias que minimizan la fricción en tus retornos.", "Comparar las comisiones de intercambio requiere comprender tu patrón real de negociación."], scenarios: ["Un trader ejecuta 50 operaciones por mes, tamaño promedio $3,000, usando órdenes taker.", "Un trader DeFi se mueve entre CEX y DEX."], checklist: ["Antes de seleccionar un intercambio, calcula tu costo mensual esperado de comisiones.", "Evalúa los mecanismos de reducción de comisiones disponibles."], mistakes: ["Evaluar las comisiones del exchange de forma aislada sin considerar la calidad de la liquidez.", "Descuidar las tasas de financiamiento para posiciones de futuros perpetuos."], benchmarks: ["Puntos de referencia de comisiones de los principales CEX (nivel estándar).", "Cálculo del impacto de la optimización de comisiones."], execution: ["Implementa una estrategia de intercambio por niveles.", "Maximiza el porcentaje de órdenes maker."], hygiene: ["Rastrea todas las comisiones de intercambio pagadas mensualmente.", "Revisa las estructuras de comisiones del exchange trimestralmente."], validation: ["Verifica los montos de comisiones reconciliando los estados de cuenta del intercambio con tus propios cálculos.", "Prueba tus estrategias de optimización de comisiones antes de comprometerte con ellas."] },
    pt: { interpret: ["A análise de taxas de exchange revela o custo real da atividade de negociação e ajuda a selecionar plataformas e estratégias que minimizam o atrito nos retornos.", "Comparar taxas de exchange requer entender seu padrão real de negociação."], scenarios: ["Um trader executa 50 negociações por mês, tamanho médio $3.000, usando ordens taker.", "Um trader DeFi move entre CEX e DEX."], checklist: ["Antes de selecionar uma exchange, calcule seu custo mensal esperado de taxas.", "Avalie os mecanismos de redução de taxas disponíveis."], mistakes: ["Avaliar taxas de exchange isoladamente sem considerar a qualidade da liquidez.", "Negligenciar taxas de financiamento para posições de futuros perpétuos."], benchmarks: ["Benchmarks de taxas das principais CEXs (nível padrão).", "Cálculo do impacto da otimização de taxas."], execution: ["Implemente uma estratégia de exchange em camadas.", "Maximize a porcentagem de ordens maker."], hygiene: ["Rastreie todas as taxas de exchange pagas mensalmente.", "Revise as estruturas de taxas de exchange trimestralmente."], validation: ["Verifique os valores das taxas reconciliando extratos de exchange com seus próprios cálculos.", "Teste suas estratégias de otimização de taxas antes de se comprometer com elas."] },
    tr: { interpret: ["Exchange ücreti analizi, işlem aktivitesinin gerçek maliyetini ortaya koyar ve getirilerinizdeki sürtünmeyi en aza indiren platformları ve stratejileri seçmenize yardımcı olur.", "Exchange ücretlerini karşılaştırmak, gerçek işlem modelinizi anlamayı gerektirir."], scenarios: ["Bir trader, taker emirleri kullanarak aylık 50 işlem yapıyor, ortalama büyüklük 3.000 dolar.", "Bir DeFi trader'ı CEX ve DEX arasında hareket ediyor."], checklist: ["Bir exchange seçmeden önce, beklenen aylık ücret maliyetinizi hesaplayın.", "Mevcut ücret azaltma mekanizmalarını değerlendirin."], mistakes: ["Likidite kalitesini göz önünde bulundurmadan exchange ücretlerini tek başına değerlendirmek.", "Sürekli vadeli işlem pozisyonları için finansman oranlarını ihmal etmek."], benchmarks: ["Önde gelen CEX ücret kıyaslamaları (standart kademe).", "Ücret optimizasyonu etki hesaplaması."], execution: ["Kademeli bir exchange stratejisi uygulayın.", "Maker emir yüzdesini maksimize edin."], hygiene: ["Tüm ödenen exchange ücretlerini aylık olarak takip edin.", "Exchange ücret yapılarını üç ayda bir gözden geçirin."], validation: ["Exchange hesap özetlerini kendi hesaplamalarınızla mutabık hale getirerek ücret miktarlarını doğrulayın.", "Taahhütte bulunmadan önce ücret optimizasyon stratejilerinizi test edin."] },
    hi: { interpret: ["एक्सचेंज शुल्क विश्लेषण ट्रेडिंग गतिविधि की वास्तविक लागत प्रकट करता है और आपको ऐसे प्लेटफॉर्म और रणनीतियां चुनने में मदद करता है जो आपके रिटर्न पर घर्षण को कम करते हैं।", "एक्सचेंज शुल्क की तुलना करने के लिए आपके वास्तविक ट्रेडिंग पैटर्न को समझना आवश्यक है।"], scenarios: ["एक ट्रेडर मासिक 50 ट्रेड निष्पादित करता है, औसत आकार $3,000, टेकर ऑर्डर का उपयोग करके।", "एक DeFi ट्रेडर CEX और DEX के बीच जाता है।"], checklist: ["एक्सचेंज चुनने से पहले, अपनी अपेक्षित मासिक शुल्क लागत की गणना करें।", "उपलब्ध शुल्क कटौती तंत्र का मूल्यांकन करें।"], mistakes: ["तरलता गुणवत्ता को ध्यान में रखे बिना एक्सचेंज शुल्क का अलगाव में मूल्यांकन करना।", "परपेचुअल फ्यूचर्स पोजीशन के लिए फंडिंग दरों की उपेक्षा करना।"], benchmarks: ["प्रमुख CEX शुल्क बेंचमार्क (मानक स्तर)।", "शुल्क अनुकूलन प्रभाव गणना।"], execution: ["स्तरीय एक्सचेंज रणनीति लागू करें।", "मेकर ऑर्डर प्रतिशत को अधिकतम करें।"], hygiene: ["मासिक रूप से भुगतान किए गए सभी एक्सचेंज शुल्कों को ट्रैक करें।", "त्रैमासिक रूप से एक्सचेंज शुल्क संरचनाओं की समीक्षा करें।"], validation: ["अपनी खुद की गणनाओं के साथ एक्सचेंज विवरण का मिलान करके शुल्क राशियों को सत्यापित करें।", "उनके प्रति प्रतिबद्ध होने से पहले अपनी शुल्क अनुकूलन रणनीतियों का परीक्षण करें।"] },
    ru: { interpret: ["Анализ биржевых комиссий раскрывает истинную стоимость торговой деятельности и помогает выбрать платформы и стратегии, минимизирующие трение на доходность.", "Сравнение биржевых комиссий требует понимания вашего реального торгового паттерна."], scenarios: ["Трейдер совершает 50 сделок в месяц, средний размер $3 000, используя тейкерские ордера.", "DeFi-трейдер перемещается между CEX и DEX."], checklist: ["Перед выбором биржи рассчитайте ожидаемые ежемесячные расходы на комиссии.", "Оцените доступные механизмы снижения комиссий."], mistakes: ["Оценка биржевых комиссий изолированно без учёта качества ликвидности.", "Пренебрежение ставками финансирования для позиций по бессрочным фьючерсам."], benchmarks: ["Ориентиры по комиссиям ведущих CEX (стандартный уровень).", "Расчёт влияния оптимизации комиссий."], execution: ["Реализуйте многоуровневую стратегию использования бирж.", "Максимизируйте долю мейкерских ордеров."], hygiene: ["Ежемесячно отслеживайте все уплаченные биржевые комиссии.", "Ежеквартально пересматривайте структуры комиссий бирж."], validation: ["Проверяйте суммы комиссий, сопоставляя выписки биржи с собственными расчётами.", "Тестируйте стратегии оптимизации комиссий до их внедрения."] }
  },
  'portfolio-rebalancer': {
    en: {
      interpret: ["Portfolio rebalancing calculations tell you the specific trades required to restore your target asset allocation after market movements have caused drift. The key insight from rebalancing analysis isn't just which assets to buy and sell — it's the magnitude of drift and whether it exceeds your rebalancing threshold. Small drift within ±5% of target allocation typically doesn't justify rebalancing transaction costs; drift above ±15%–20% generally does. The calculation reveals not just what to trade, but whether to trade at all given current fee and tax considerations.", "When rebalancing a crypto portfolio, the mathematical outcome depends on whether you're using absolute rebalancing (restore exact target percentages) or threshold rebalancing (only rebalance when any allocation drifts beyond a set band). Absolute rebalancing creates higher transaction frequency but tighter target adherence. Threshold rebalancing reduces costs but allows greater temporary drift. For volatile assets like crypto, threshold bands of 5%–10% around target allocations typically provide the optimal balance between cost and precision."],
      scenarios: ["Starting allocation: BTC 40%, ETH 30%, SOL 20%, stablecoins 10%. After a bull run: BTC 55%, ETH 35%, SOL 8%, stablecoins 2%. Rebalancing analysis shows BTC is 15% overweight, SOL is 12% underweight, stablecoins are 8% underweight. Trades required: sell $15,000 BTC, sell $5,000 ETH (minor trim), buy $12,000 SOL, buy $8,000 stablecoins. Total transaction volume: $40,000. At 0.1% fee: $40 in fees. Estimated tax on sold positions: depends on holding period and gains — could range from $0 to $3,000+ depending on tax situation.", "A DeFi investor's portfolio has drifted: yield farming position grew to 45% from target 30%, BTC dropped to 25% from target 40%. Rebalancing requires exiting $15,000 of yield farming positions (complex multi-step: unstake, remove liquidity, bridge, sell) and deploying $15,000 into BTC spot. The rebalancing cost estimate: $50 gas + $100 bridge fee + $15 trading fee = $165 total, or 1.1% of the rebalancing trade size. This friction cost must be weighed against the risk reduction benefit."],
      checklist: ["Before rebalancing, verify the current portfolio is accurately valued — DeFi positions may show stale prices, and LP position values include impermanent loss that may not be reflected in simple token price × quantity calculations. Use a portfolio aggregator that accounts for LP position values accurately before calculating rebalancing trades.", "Calculate the tax impact of proposed rebalancing trades separately from the fee impact. In jurisdictions with capital gains taxes, selling appreciated positions triggers taxable events regardless of whether proceeds are reinvested. Model whether it's more advantageous to rebalance by directing new contributions to underweight assets (tax-free accumulation) versus selling overweight positions (triggering tax). New capital deployment rebalancing is almost always tax-superior if new capital is available."],
      mistakes: ["Rebalancing too frequently in response to normal volatility creates unnecessary transaction costs and potential tax drag without meaningful risk reduction. Rebalancing triggers should be based on drift magnitude and time elapsed, not on portfolio value changes. A portfolio that swings 20% in value due to market movement without changing relative allocation ratios doesn't need rebalancing — price movement isn't the trigger, allocation drift is.", "Treating rebalancing as a uniform process across all asset types. Liquid spot holdings can be rebalanced with simple market or limit orders. DeFi positions may require days of unwinding through lock-up periods, claim queues, or illiquid markets. Always account for position liquidity and unwinding complexity when planning a rebalancing operation — attempting to rebalance illiquid positions on a tight timeline often results in suboptimal execution prices."],
      benchmarks: ["Academic research on rebalancing frequency suggests annual or semi-annual rebalancing provides 80%–90% of the risk-reduction benefit of continuous rebalancing, at a fraction of the transaction cost. Monthly rebalancing produces marginally better risk metrics but significantly higher costs. For a $100,000 crypto portfolio, annual rebalancing typically costs $100–$300 in fees versus $1,200–$3,600 for monthly rebalancing — without proportional benefit.", "Rebalancing in volatile markets produces a systematic 'rebalancing bonus' — by mechanically buying assets that have declined and selling those that have appreciated, rebalancing protocols automatically buy low and sell high in relative terms. Studies of crypto portfolios from 2017–2023 show that disciplined quarterly rebalancing added 2%–5% annually to portfolio returns compared to pure buy-and-hold, primarily through capturing mean-reversion in volatile alt/BTC relationships."],
      execution: ["Sequence rebalancing trades to minimize market impact. Start with the smallest required position changes to test execution quality, then proceed to larger trades. For large rebalancing operations (>$50,000 in trades), split execution over 2–3 days during different liquidity windows rather than executing everything simultaneously — this reduces market impact and provides price averaging across execution days.", "Use rebalancing as an opportunity to consolidate small positions into meaningful ones. If your portfolio has 20+ assets with many sub-1% allocations from historical accumulation, use a rebalancing event to exit the smallest positions and redeploy into your conviction positions. Simplification reduces ongoing monitoring overhead and often improves execution quality for positions that matter."],
      hygiene: ["Schedule automatic rebalancing review reminders quarterly and after any month where total portfolio value changes by more than 30%. Set up portfolio tracking alerts that notify you when any individual allocation drifts beyond ±10% from target. These triggers ensure rebalancing decisions are responsive to conditions rather than based on arbitrary calendar intervals.", "Document each rebalancing decision: what triggered it, what trades were executed, total cost including fees and tax, and whether the post-rebalancing allocation achieved the intended target. This discipline creates a learning loop — reviewing historical rebalancing decisions reveals whether your thresholds are well-calibrated and whether execution consistently achieves intended outcomes."],
      validation: ["After executing rebalancing trades, verify the resulting allocation against your target using current prices. Market movements during the execution period (even minutes for large rebalancing operations) can cause the final allocation to differ from the intended result. Spot-check the final allocation immediately after execution and make small corrective trades if any single position drifted more than 2% from target during execution.", "Backtest your rebalancing strategy against historical portfolio data before implementing changes to your approach. Using historical price data, simulate what your portfolio would have been worth under your current rebalancing rules versus alternative rules (different bands, different frequencies). This quantitative validation reveals whether your intended strategy actually outperforms simpler alternatives over the specific historical periods relevant to your assets."]
    },
    es: { interpret: ["Los cálculos de reequilibrio de cartera te dicen las operaciones específicas necesarias para restaurar tu asignación objetivo de activos después de que los movimientos del mercado hayan causado desviación.", "Cuando se reequilibra una cartera cripto, el resultado matemático depende de si usas el reequilibrio absoluto o por umbral."], scenarios: ["Asignación inicial: BTC 40%, ETH 30%, SOL 20%, stablecoins 10%. Después de un mercado alcista: BTC 55%, ETH 35%, SOL 8%, stablecoins 2%.", "La cartera de un inversor DeFi se ha desviado: la posición de yield farming creció al 45% desde el objetivo del 30%."], checklist: ["Antes de reequilibrar, verifica que la cartera actual esté valorada con precisión.", "Calcula el impacto fiscal de las operaciones de reequilibrio propuestas por separado del impacto en las comisiones."], mistakes: ["Reequilibrar con demasiada frecuencia en respuesta a la volatilidad normal crea costos innecesarios de transacción.", "Tratar el reequilibrio como un proceso uniforme en todos los tipos de activos."], benchmarks: ["La investigación académica sobre la frecuencia de reequilibrio sugiere que el reequilibrio anual o semestral proporciona el 80%–90% del beneficio de reducción de riesgo.", "El reequilibrio en mercados volátiles produce un 'bono de reequilibrio' sistemático."], execution: ["Secuencia las operaciones de reequilibrio para minimizar el impacto en el mercado.", "Usa el reequilibrio como oportunidad para consolidar posiciones pequeñas en posiciones significativas."], hygiene: ["Programa recordatorios automáticos de revisión de reequilibrio trimestralmente.", "Documenta cada decisión de reequilibrio."], validation: ["Después de ejecutar las operaciones de reequilibrio, verifica la asignación resultante con los precios actuales.", "Realiza backtesting de tu estrategia de reequilibrio contra datos históricos de cartera."] },
    pt: { interpret: ["Os cálculos de rebalanceamento de portfólio informam as negociações específicas necessárias para restaurar sua alocação de ativos alvo após os movimentos de mercado terem causado desvio.", "Ao rebalancear um portfólio cripto, o resultado matemático depende de usar rebalanceamento absoluto ou de limite."], scenarios: ["Alocação inicial: BTC 40%, ETH 30%, SOL 20%, stablecoins 10%. Após um mercado em alta: BTC 55%, ETH 35%, SOL 8%, stablecoins 2%.", "O portfólio de um investidor DeFi se desviou: a posição de yield farming cresceu para 45% desde o alvo de 30%."], checklist: ["Antes de rebalancear, verifique se o portfólio atual está valorado com precisão.", "Calcule o impacto fiscal das negociações de rebalanceamento propostas separadamente do impacto nas taxas."], mistakes: ["Rebalancear com muita frequência em resposta à volatilidade normal cria custos desnecessários de transação.", "Tratar o rebalanceamento como um processo uniforme em todos os tipos de ativos."], benchmarks: ["A pesquisa acadêmica sobre frequência de rebalanceamento sugere que o rebalanceamento anual ou semestral fornece 80%–90% do benefício de redução de risco.", "O rebalanceamento em mercados voláteis produz um 'bônus de rebalanceamento' sistemático."], execution: ["Sequencie as negociações de rebalanceamento para minimizar o impacto no mercado.", "Use o rebalanceamento como oportunidade para consolidar pequenas posições em posições significativas."], hygiene: ["Agende lembretes automáticos de revisão de rebalanceamento trimestralmente.", "Documente cada decisão de rebalanceamento."], validation: ["Após executar as negociações de rebalanceamento, verifique a alocação resultante com os preços atuais.", "Faça backtest de sua estratégia de rebalanceamento contra dados históricos de portfólio."] },
    tr: { interpret: ["Portföy yeniden dengeleme hesaplamaları, piyasa hareketlerinin sapmaya neden olmasının ardından hedef varlık dağılımınızı geri kazanmak için gereken özel işlemleri size söyler.", "Bir kripto portföyü yeniden dengelerken matematiksel sonuç, mutlak veya eşik yeniden dengeleme kullanıp kullanmadığınıza bağlıdır."], scenarios: ["Başlangıç dağılımı: BTC %40, ETH %30, SOL %20, stabilcoin %10. Boğa koşusundan sonra: BTC %55, ETH %35, SOL %8, stabilcoin %2.", "Bir DeFi yatırımcısının portföyü sapttı: yield farming pozisyonu %30 hedeften %45'e büyüdü."], checklist: ["Yeniden dengelemeden önce, mevcut portföyün doğru değerlendiğini doğrulayın.", "Önerilen yeniden dengeleme işlemlerinin vergi etkisini ücret etkisinden ayrı olarak hesaplayın."], mistakes: ["Normal oynaklığa yanıt olarak çok sık yeniden dengeleme yapmak gereksiz işlem maliyetleri yaratır.", "Yeniden dengelemeyi tüm varlık türlerinde tekdüze bir süreç olarak ele almak."], benchmarks: ["Yeniden dengeleme sıklığı üzerine akademik araştırmalar, yıllık veya yarı yıllık yeniden dengelemenin risk azaltma faydasının %80–%90'ını sağladığını öne sürüyor.", "Dalgalı piyasalarda yeniden dengeleme sistematik bir 'yeniden dengeleme bonusu' üretir."], execution: ["Piyasa etkisini minimize etmek için yeniden dengeleme işlemlerini sıralayın.", "Küçük pozisyonları anlamlı olanlarda pekiştirmek için yeniden dengelemeyi fırsat olarak kullanın."], hygiene: ["Üç ayda bir otomatik yeniden dengeleme inceleme hatırlatıcıları planlayın.", "Her yeniden dengeleme kararını belgeleyin."], validation: ["Yeniden dengeleme işlemlerini yürüttükten sonra, mevcut fiyatlarla elde edilen dağılımı doğrulayın.", "Yeniden dengeleme stratejinizi tarihsel portföy verileriyle geriye dönük test edin."] },
    hi: { interpret: ["पोर्टफोलियो रीबैलेंसिंग गणनाएं आपको वे विशिष्ट ट्रेड बताती हैं जो बाजार के उतार-चढ़ाव के कारण बहाव के बाद आपके लक्ष्य संपत्ति आवंटन को बहाल करने के लिए आवश्यक हैं।", "क्रिप्टो पोर्टफोलियो को रीबैलेंस करते समय, गणितीय परिणाम इस बात पर निर्भर करता है कि आप पूर्ण रीबैलेंसिंग या थ्रेशोल्ड रीबैलेंसिंग का उपयोग कर रहे हैं।"], scenarios: ["प्रारंभिक आवंटन: BTC 40%, ETH 30%, SOL 20%, स्टेबलकॉइन 10%। एक बुल रन के बाद: BTC 55%, ETH 35%, SOL 8%, स्टेबलकॉइन 2%।", "एक DeFi निवेशक के पोर्टफोलियो में बहाव आया: यील्ड फार्मिंग पोजीशन लक्ष्य 30% से 45% तक बढ़ गई।"], checklist: ["रीबैलेंस करने से पहले, सत्यापित करें कि वर्तमान पोर्टफोलियो का सटीक मूल्यांकन किया गया है।", "प्रस्तावित रीबैलेंसिंग ट्रेड के कर प्रभाव की गणना शुल्क प्रभाव से अलग करें।"], mistakes: ["सामान्य अस्थिरता के जवाब में बहुत बार रीबैलेंस करना अनावश्यक लेनदेन लागत बनाता है।", "सभी संपत्ति प्रकारों में रीबैलेंसिंग को एक समान प्रक्रिया के रूप में मानना।"], benchmarks: ["रीबैलेंसिंग आवृत्ति पर शैक्षणिक अनुसंधान बताता है कि वार्षिक या अर्ध-वार्षिक रीबैलेंसिंग जोखिम-कटौती लाभ का 80%–90% प्रदान करती है।", "अस्थिर बाजारों में रीबैलेंसिंग एक व्यवस्थित 'रीबैलेंसिंग बोनस' उत्पन्न करता है।"], execution: ["बाजार प्रभाव को कम करने के लिए रीबैलेंसिंग ट्रेड को क्रमबद्ध करें।", "छोटी पोजीशन को सार्थक पोजीशन में समेकित करने के लिए रीबैलेंसिंग का उपयोग अवसर के रूप में करें।"], hygiene: ["त्रैमासिक रूप से स्वचालित रीबैलेंसिंग समीक्षा रिमाइंडर शेड्यूल करें।", "प्रत्येक रीबैलेंसिंग निर्णय का दस्तावेज़ीकरण करें।"], validation: ["रीबैलेंसिंग ट्रेड निष्पादित करने के बाद, वर्तमान कीमतों के साथ परिणामी आवंटन सत्यापित करें।", "ऐतिहासिक पोर्टफोलियो डेटा के खिलाफ अपनी रीबैलेंसिंग रणनीति का बैकटेस्ट करें।"] },
    ru: { interpret: ["Расчёты ребалансировки портфеля показывают конкретные сделки, необходимые для восстановления целевого распределения активов после того, как рыночные движения вызвали отклонение.", "При ребалансировке крипто-портфеля математический результат зависит от того, используете ли вы абсолютную или пороговую ребалансировку."], scenarios: ["Начальное распределение: BTC 40%, ETH 30%, SOL 20%, стейблкоины 10%. После бычьего рынка: BTC 55%, ETH 35%, SOL 8%, стейблкоины 2%.", "Портфель DeFi-инвестора сместился: позиция yield farming выросла с целевых 30% до 45%."], checklist: ["Перед ребалансировкой убедитесь, что текущий портфель оценён точно.", "Рассчитайте налоговое воздействие предлагаемых ребалансирующих сделок отдельно от воздействия комиссий."], mistakes: ["Слишком частая ребалансировка в ответ на нормальную волатильность создаёт излишние транзакционные издержки.", "Отношение к ребалансировке как к единому процессу для всех типов активов."], benchmarks: ["Академические исследования частоты ребалансировки показывают, что ежегодная или полугодовая ребалансировка даёт 80–90% эффекта снижения риска.", "Ребалансировка на волатильных рынках производит систематический «бонус ребалансировки»."], execution: ["Последовательно выполняйте ребалансирующие сделки для минимизации рыночного воздействия.", "Используйте ребалансировку как возможность консолидировать небольшие позиции в значимые."], hygiene: ["Устанавливайте автоматические напоминания о ребалансировке ежеквартально.", "Документируйте каждое решение о ребалансировке."], validation: ["После выполнения ребалансирующих сделок проверьте итоговое распределение по текущим ценам.", "Проводите бэктест стратегии ребалансировки на исторических данных портфеля."] }
  },
  'tax-calculator': {
    en: {
      interpret: ["Crypto tax calculations convert raw trading activity into taxable events categorized by jurisdiction-specific rules. The most critical interpretation challenge is correctly identifying which transactions are taxable events: in most jurisdictions, trading crypto-to-crypto is a taxable event (not just crypto-to-fiat), receiving staking rewards is ordinary income at fair market value, and using crypto to purchase goods creates capital gains events. A wallet history showing 500 transactions may actually contain 400 taxable events that generate both income and capital gains across multiple tax categories.", "The cost basis method you select dramatically affects your calculated tax liability. FIFO (first-in, first-out) uses the oldest purchased tokens to calculate gains — favorable in rising markets where old coins have low cost basis, but creates large taxable gains. LIFO (last-in, first-out) uses most recent tokens — favorable in falling markets. Specific identification (HIFO — highest-in, first-out) minimizes current-period gains by matching sales to your highest-cost-basis tokens first. Selecting the optimal method legally can reduce your tax liability by 20%–40% compared to the default method."],
      scenarios: ["A trader purchased 1 BTC at three different times: $10,000 (Jan), $30,000 (Mar), $20,000 (Sep). Now sells 0.5 BTC at $50,000 each ($25,000 total). FIFO cost basis: 0.5 × $10,000 = $5,000 cost, taxable gain = $20,000. LIFO cost basis: 0.5 × $20,000 = $10,000 cost, taxable gain = $15,000. HIFO cost basis: 0.5 × $30,000 = $15,000 cost, taxable gain = $10,000. Tax liability difference (30% tax rate): FIFO = $6,000 taxes vs. HIFO = $3,000 taxes — $3,000 difference from purely choosing the right accounting method.", "A DeFi yield farmer received: $12,000 in staking rewards (ordinary income), $8,000 in liquidity mining tokens (ordinary income at receipt), realized $25,000 in gains from LP position exits, and lost $15,000 in an exchange hack. Total taxable income from staking+mining = $20,000 ordinary income. Capital gains = $25,000. Capital loss from hack = $15,000 (check jurisdiction rules for theft losses). Net capital gains = $10,000. Combined with ordinary income, total taxable crypto income = $30,000."],
      checklist: ["Compile a complete transaction history from every wallet and exchange you've used in the tax year: CEX trade histories (downloadable as CSV), DEX transactions from blockchain explorers, staking rewards with dates and fair market values at receipt, NFT sales with cost basis documentation, and any tokens received through airdrops, forks, or interest payments. Missing any category creates potential audit exposure.", "Apply your jurisdiction's specific tax treatment to each transaction category. US rules differ significantly from UK rules (which use Section 104 pooling), EU rules (which vary by country), and other jurisdictions. Never apply general crypto tax advice without verifying it applies to your specific country's tax code — the tax treatment of staking, DeFi income, and NFTs varies significantly across jurisdictions."],
      mistakes: ["Failing to report small transactions or DeFi income below certain thresholds. In most jurisdictions, there is no de minimis exclusion for crypto gains — even a $10 gain from a minor trade is technically reportable. Selective reporting of only large gains while omitting small ones creates audit inconsistencies that tax authorities specifically look for. Report all transactions regardless of size.", "Using price data at the wrong timestamp. Tax calculations require the fair market value at the exact moment of each transaction, not an end-of-day average or a price from hours later. For DeFi transactions that happen at specific block timestamps, using the price at that exact block is required. Price data inaccuracies can accumulate to create materially incorrect tax filings that expose you to penalties."],
      benchmarks: ["Effective crypto tax rates vary significantly: long-term capital gains (held >1 year in the US) are taxed at 0%–20% depending on income bracket. Short-term gains (held <1 year) are taxed as ordinary income at 10%–37%. Staking rewards and mining income are always ordinary income. For high-income taxpayers, the tax rate difference between holding 364 days (short-term) vs. 366 days (long-term) can be 17%+ — making holding period management a critical tax optimization tool.", "Crypto tax software accuracy benchmarks: leading platforms (Koinly, CoinTracker, TaxBit) correctly process 90%–95% of standard trading transactions but struggle with complex DeFi interactions, LP positions, and multi-chain bridge transactions. For portfolios with significant DeFi activity, expect to manually review and correct 10%–20% of automatically generated tax records. The more complex your activity, the more critical manual review becomes."],
      execution: ["Implement a tax-loss harvesting strategy: systematically sell positions with unrealized losses before year-end to generate deductible capital losses, then repurchase the same or similar assets if you wish to maintain exposure. Unlike traditional securities (where wash sale rules prohibit this in 30 days), most jurisdictions currently allow crypto wash sale-like strategies. A $20,000 unrealized loss harvested at a 25% marginal rate generates $5,000 in tax savings.", "Work with a crypto-specialized accountant for portfolios with significant DeFi activity. The tax treatment of liquidity provision, yield farming, protocol rewards, and bridge transactions remains ambiguous in many jurisdictions, and filing positions depend on interpretations that experienced crypto accountants have developed. The cost of professional tax preparation (typically $500–$3,000) is usually offset by tax savings from properly applied deductions."],
      hygiene: ["Maintain real-time transaction records throughout the year rather than reconciling retrospectively at tax time. For each taxable event, record: date and time, asset type, quantity, price in USD at transaction time, transaction type (trade, staking reward, airdrop, etc.), and relevant wallet addresses. This contemporaneous record is far easier to audit-verify than reconstructed records from exchange histories.", "Export and archive exchange trade histories quarterly. Exchanges can and do close, restrict accounts, and modify historical data availability. If you wait until tax season to export 3 years of trade history, some may no longer be available. Store exports in multiple formats (CSV, PDF) in secure cloud storage and local backup to ensure availability when needed for tax filing or potential audits."],
      validation: ["Reconcile your crypto tax software output against your actual wallet balances. The ending balance calculated from your tax software's transaction history should match your actual wallet holdings. Discrepancies reveal missing transactions, incorrect accounting, or data import errors. A simple check: sum all purchases minus sum all sales minus any transfers. The result should match current holdings — any gap indicates unreported transactions.", "Have your crypto tax calculations reviewed by a second source before filing — either a different software platform or a human reviewer. Input the same transaction data into two separate tax platforms and compare the outputs. Differences above 5% indicate that platform-specific interpretations of ambiguous transactions are creating material discrepancies that need professional resolution."]
    },
    es: { interpret: ["Los cálculos de impuestos cripto convierten la actividad de trading bruta en eventos imponibles categorizados por reglas específicas de cada jurisdicción.", "El método de base de costo que selecciones afecta dramáticamente tu responsabilidad fiscal calculada."], scenarios: ["Un trader compró 1 BTC en tres momentos diferentes. Ahora vende 0.5 BTC a $50,000 cada uno.", "Un yield farmer DeFi recibió: $12,000 en recompensas de staking, $8,000 en tokens de minería de liquidez."], checklist: ["Compila un historial completo de transacciones de cada billetera y exchange que hayas utilizado en el año fiscal.", "Aplica el tratamiento fiscal específico de tu jurisdicción a cada categoría de transacción."], mistakes: ["No declarar pequeñas transacciones o ingresos DeFi por debajo de ciertos umbrales.", "Usar datos de precios con la marca de tiempo incorrecta."], benchmarks: ["Las tasas efectivas de impuestos cripto varían significativamente: las ganancias de capital a largo plazo (retenidas más de 1 año en EE.UU.) se gravan al 0%–20% según el tramo de ingresos.", "Benchmarks de precisión del software de impuestos cripto: las principales plataformas procesan correctamente el 90%–95% de las transacciones de trading estándar."], execution: ["Implementa una estrategia de cosecha de pérdidas fiscales.", "Trabaja con un contador especializado en cripto para carteras con actividad DeFi significativa."], hygiene: ["Mantén registros de transacciones en tiempo real durante todo el año.", "Exporta y archiva historiales de trading de exchanges trimestralmente."], validation: ["Reconcilia el resultado del software de impuestos cripto con los saldos reales de tu billetera.", "Haz que tus cálculos de impuestos cripto sean revisados por una segunda fuente antes de presentar."] },
    pt: { interpret: ["Os cálculos de impostos cripto convertem a atividade de trading bruta em eventos tributáveis categorizados por regras específicas da jurisdição.", "O método de base de custo que você seleciona afeta dramaticamente sua responsabilidade fiscal calculada."], scenarios: ["Um trader comprou 1 BTC em três momentos diferentes. Agora vende 0,5 BTC a $50.000 cada.", "Um yield farmer DeFi recebeu: $12.000 em recompensas de staking, $8.000 em tokens de mineração de liquidez."], checklist: ["Compile um histórico completo de transações de cada carteira e exchange que você usou no ano fiscal.", "Aplique o tratamento fiscal específico da sua jurisdição a cada categoria de transação."], mistakes: ["Deixar de reportar pequenas transações ou renda DeFi abaixo de certos limites.", "Usar dados de preços com o timestamp errado."], benchmarks: ["As taxas efetivas de imposto cripto variam significativamente: ganhos de capital de longo prazo (mantidos por mais de 1 ano nos EUA) são tributados de 0%–20%.", "Benchmarks de precisão de software de imposto cripto: as principais plataformas processam corretamente 90%–95% das transações de trading padrão."], execution: ["Implemente uma estratégia de coleta de perdas fiscais.", "Trabalhe com um contador especializado em cripto para portfólios com atividade DeFi significativa."], hygiene: ["Mantenha registros de transações em tempo real ao longo do ano.", "Exporte e arquive históricos de negociação de exchanges trimestralmente."], validation: ["Reconcilie a saída do software de imposto cripto com seus saldos reais de carteira.", "Tenha seus cálculos de imposto cripto revisados por uma segunda fonte antes de declarar."] },
    tr: { interpret: ["Kripto vergi hesaplamaları, ham işlem aktivitesini yargı yetkisine özgü kurallara göre sınıflandırılmış vergilendirilebilir olaylara dönüştürür.", "Seçtiğiniz maliyet tabanı yöntemi, hesaplanan vergi yükümlülüğünüzü dramatik biçimde etkiler."], scenarios: ["Bir trader, 1 BTC'yi üç farklı zamanda satın aldı. Şimdi 0,5 BTC'yi her biri 50.000 dolardan satıyor.", "Bir DeFi yield farmer'ı şunları aldı: 12.000 dolar staking ödülleri, 8.000 dolar likidite madenciliği tokenleri."], checklist: ["Vergi yılında kullandığınız her cüzdan ve exchange'den eksiksiz bir işlem geçmişi derleyin.", "Her işlem kategorisine yargı yetkisine özgü vergi muamelesini uygulayın."], mistakes: ["Belirli eşiklerin altındaki küçük işlemleri veya DeFi gelirini bildirmemek.", "Fiyat verilerini yanlış zaman damgasıyla kullanmak."], benchmarks: ["Efektif kripto vergi oranları önemli ölçüde farklılık gösteriyor: uzun vadeli sermaye kazançları (ABD'de 1 yıldan fazla tutulan) gelir dilimine bağlı olarak %0–%20 oranında vergilendirilir.", "Kripto vergi yazılımı doğruluk kıyaslamaları: önde gelen platformlar standart işlemlerin %90–%95'ini doğru şekilde işler."], execution: ["Vergi kaybı hasat stratejisi uygulayın.", "Önemli DeFi aktivitesine sahip portföyler için kripto konusunda uzmanlaşmış bir muhasebeciye başvurun."], hygiene: ["Yıl boyunca gerçek zamanlı işlem kayıtlarını tutun.", "Exchange işlem geçmişlerini üç ayda bir dışa aktarın ve arşivleyin."], validation: ["Kripto vergi yazılımınızın çıktısını gerçek cüzdan bakiyelerinizle mutabık hale getirin.", "Kripto vergi hesaplamalarınızı beyan etmeden önce ikinci bir kaynakla gözden geçirin."] },
    hi: { interpret: ["क्रिप्टो कर गणनाएं कच्चे ट्रेडिंग गतिविधि को अधिकार क्षेत्र-विशिष्ट नियमों द्वारा वर्गीकृत कर योग्य घटनाओं में परिवर्तित करती हैं।", "आप जो लागत आधार विधि चुनते हैं वह आपकी गणना की गई कर देनदारी को नाटकीय रूप से प्रभावित करती है।"], scenarios: ["एक ट्रेडर ने तीन अलग-अलग समयों पर 1 BTC खरीदा। अब $50,000 प्रत्येक पर 0.5 BTC बेचता है।", "एक DeFi यील्ड फार्मर को प्राप्त हुआ: $12,000 स्टेकिंग पुरस्कार, $8,000 तरलता खनन टोकन।"], checklist: ["कर वर्ष में उपयोग किए गए प्रत्येक वॉलेट और एक्सचेंज से पूर्ण लेनदेन इतिहास संकलित करें।", "प्रत्येक लेनदेन श्रेणी पर अपने अधिकार क्षेत्र का विशिष्ट कर उपचार लागू करें।"], mistakes: ["कुछ सीमाओं से नीचे छोटे लेनदेन या DeFi आय की रिपोर्ट न करना।", "गलत टाइमस्टैम्प पर मूल्य डेटा का उपयोग करना।"], benchmarks: ["प्रभावी क्रिप्टो कर दरें काफी भिन्न होती हैं: दीर्घकालिक पूंजी लाभ (अमेरिका में 1 वर्ष से अधिक रखे गए) आय वर्ग के आधार पर 0%–20% पर लगाए जाते हैं।", "क्रिप्टो कर सॉफ़्टवेयर सटीकता बेंचमार्क: प्रमुख प्लेटफॉर्म मानक ट्रेडिंग लेनदेन के 90%–95% को सही ढंग से प्रोसेस करते हैं।"], execution: ["कर-हानि संचय रणनीति लागू करें।", "महत्वपूर्ण DeFi गतिविधि वाले पोर्टफोलियो के लिए क्रिप्टो-विशेषज्ञ एकाउंटेंट के साथ काम करें।"], hygiene: ["पूरे वर्ष रीयल-टाइम लेनदेन रिकॉर्ड बनाए रखें।", "एक्सचेंज ट्रेड इतिहास को त्रैमासिक रूप से निर्यात और संग्रहीत करें।"], validation: ["क्रिप्टो कर सॉफ़्टवेयर आउटपुट को वास्तविक वॉलेट बैलेंस के साथ समेटें।", "फाइल करने से पहले क्रिप्टो कर गणनाओं को दूसरे स्रोत से समीक्षा करवाएं।"] },
    ru: { interpret: ["Расчёты крипто-налогов преобразуют сырую торговую активность в налогооблагаемые события, классифицированные по правилам конкретной юрисдикции.", "Выбранный метод определения базы стоимости кардинально влияет на рассчитанное налоговое обязательство."], scenarios: ["Трейдер купил 1 BTC в три разных момента. Теперь продаёт 0,5 BTC по $50 000 каждый.", "DeFi yield farmer получил: $12 000 в виде стейкинговых вознаграждений, $8 000 в токенах майнинга ликвидности."], checklist: ["Составьте полную историю транзакций с каждого кошелька и биржи, использованных в налоговом году.", "Применяйте специфическое налоговое регулирование своей юрисдикции к каждой категории транзакций."], mistakes: ["Не декларировать мелкие транзакции или доходы от DeFi ниже определённых порогов.", "Использовать ценовые данные с неверной временной меткой."], benchmarks: ["Эффективные ставки крипто-налога существенно различаются: долгосрочный прирост капитала (удерживаемый более 1 года в США) облагается по ставке 0–20% в зависимости от налогового диапазона.", "Точность крипто-налогового ПО: ведущие платформы корректно обрабатывают 90–95% стандартных торговых транзакций."], execution: ["Реализуйте стратегию налоговой уборки убытков.", "Для портфелей со значительной DeFi-активностью работайте с бухгалтером, специализирующимся на криптовалютах."], hygiene: ["Ведите записи транзакций в режиме реального времени в течение всего года.", "Ежеквартально экспортируйте и архивируйте истории торгов на биржах."], validation: ["Сверяйте вывод крипто-налогового ПО с фактическими балансами кошельков.", "Перед подачей декларации проверьте расчёты крипто-налога через второй источник."] }
  },
  'dollar-cost-averaging': {
    en: {
      interpret: ["DCA (dollar-cost averaging) calculation results show you the average cost basis achieved by spreading purchases over time — a figure that reveals whether your systematic buying approach has been accumulating above or below current market price. An average cost basis below the current price means your DCA strategy is working: you've accumulated coins at a lower average price than today's, creating built-in unrealized profit. An average cost basis above current price reveals that market timing has been unfavorable, but crucially, continuing the DCA during this period is buying at discount relative to your existing holdings.", "The power of DCA becomes most apparent during bear markets: each periodic purchase buys more coins at lower prices, dramatically lowering the average cost basis over time. A Bitcoin investor who DCA'd $500 monthly for 3 years through a bear-to-bull cycle typically ends up with a cost basis 30%–60% lower than an investor who made a single lump-sum purchase at the start of the same period — the difference between accumulating 35 Bitcoin vs. 22 Bitcoin for the same total dollar investment."],
      scenarios: ["A DCA investor buys $100 of ETH each week for 52 weeks. Week 1–10: ETH at $2,000, accumulating 0.5 ETH per week = 5 ETH total. Week 11–30: ETH drops to $1,000, accumulating 1.0 ETH per week = 20 ETH total. Week 31–52: ETH recovers to $1,500, accumulating 0.67 ETH per week = 14.7 ETH total. After 52 weeks: 39.7 ETH purchased for $5,200 total. Average cost: $131 per ETH. Current value at $1,500: $59,550. Return: 1,045%. A single $5,200 purchase in Week 1 at $2,000 would have yielded only 2.6 ETH worth $3,900 — 35% less.", "An investor DCA's $200/month into a new altcoin for 24 months. Average entry price: $0.45 from their purchases. Current price: $0.30 (33% below average). Total invested: $4,800. Current value: $3,200. The DCA model indicates they should continue — their current purchases at $0.30 are significantly below their average, which will lower the cost basis if the asset eventually recovers. Stopping DCA here locks in the current average while missing the accumulation advantage of the discount price."],
      checklist: ["Before implementing a DCA strategy, define: the total capital you're willing to commit, the period over which you'll invest (6 months, 1 year, 3 years), the frequency of purchases (daily, weekly, monthly), and the trigger conditions under which you'd deviate from the plan (major fundamental change, exchange insolvency, personal emergency). Having explicit rules prevents emotional deviation during market extremes.", "Calculate your DCA break-even: at what average cost basis and what percentage of your total planned investment deployed does the strategy become profitable even if you stop contributing? If you've invested 50% of planned capital and the current value equals your investment, continuing means you're buying at a favorable price. If you've invested 90% of planned capital and value has dropped 80%, the remaining 10% provides minimal improvement — assess whether continuing makes sense."],
      mistakes: ["Confusing DCA with a guarantee of positive returns. DCA reduces the impact of poor timing but doesn't eliminate the risk of a permanently declining asset. If a coin you're DCA'ing into goes to zero, your average cost basis becomes irrelevant — DCA in a declining asset simply ensures you bought more coins worth nothing. Always apply fundamental quality filters to DCA targets: only DCA assets you'd be comfortable holding through a 90% drawdown and still believe have long-term value.", "Abandoning the DCA strategy during market downturns when it's most advantageous. The temptation to pause purchases when markets are down 50%–70% is strongest precisely when DCA is creating the most value. The behavioral challenge is maintaining systematic buying during periods of maximum fear — the discipline to continue buying during severe bear markets is what separates successful DCA outcomes from failed ones."],
      benchmarks: ["Historical DCA performance vs. lump sum: over rolling 10-year Bitcoin investment periods, DCA (monthly purchases) underperformed lump sum in 60% of scenarios in a rising market (because deployed capital later missed early gains) but outperformed lump sum in 100% of scenarios that included bear markets. For assets with high volatility and mean-reversion characteristics, DCA consistently outperforms in volatile market environments.", "DCA frequency optimization: monthly DCA produces 85%–90% of the variance reduction benefit of weekly DCA with 4x fewer transactions and proportionally lower fee costs. The marginal benefit of increasing frequency beyond monthly is small for most assets. For high-volatility assets during bear markets, weekly or bi-weekly DCA provides meaningfully better cost averaging than monthly due to faster downside accumulation."],
      execution: ["Automate DCA execution through exchange recurring buy features, DeFi protocol DCA bots, or calendar-based reminders with manual execution. Automation removes the behavioral challenge of maintaining discipline during market downturns — you don't have to make a decision to buy each week, it happens automatically. The elimination of decision-making is itself valuable: it prevents both panic-selling and excitement-buying at inopportune moments.", "Review and potentially increase DCA amounts during severe market downturns (>50% from all-time-high). If your financial situation permits, temporarily doubling your DCA rate during bear markets accelerates cost basis reduction and amplifies eventual recovery returns. Some investors structure this as a 'DCA+ bear mode' where they increase purchase amounts progressively as price falls: 1.5x at -30%, 2x at -50%, 3x at -70%. This requires pre-committing excess capital, but dramatically improves bear market accumulation."],
      hygiene: ["Track DCA performance metrics monthly: number of units accumulated, average cost basis, current market value, and percentage return. Compare your cost basis progression over time to see how it's declining as you accumulate through lower prices. This tracking provides psychological reinforcement during bear markets — seeing your cost basis drop and unit count grow reminds you that the strategy is working even when portfolio value appears to be declining.", "Set a DCA review date at the planned strategy end point to evaluate whether to continue, modify, or exit the position. Use this review to reassess your fundamental thesis about the asset: has the project progressed as expected? Are the tokenomics still favorable? Has competition changed the investment case? Don't extend DCA indefinitely without deliberate reassessment — each extension should be a conscious decision, not inertia."],
      validation: ["Verify your calculated average cost basis by multiplying each historical purchase (quantity × price) and dividing the total cost by total quantity. This calculation should match your portfolio tracker's reported cost basis within rounding differences. Discrepancies indicate that your tracker is either miscalculating (possibly due to missed transactions) or applying a different accounting method than you intend.", "Compare your actual DCA returns to the theoretical lump sum return for the same period. This counterfactual analysis shows whether the DCA strategy added or subtracted value versus the alternative of investing all capital upfront. In rising markets, DCA typically underperforms lump sum; in choppy or declining-then-rising markets, DCA typically outperforms. Understanding which environment your DCA period experienced contextualizes the performance."]
    },
    es: { interpret: ["Los resultados del cálculo de DCA (promedio de costo en dólares) te muestran el costo base promedio logrado al distribuir las compras a lo largo del tiempo.", "El poder del DCA se hace más evidente durante los mercados bajistas."], scenarios: ["Un inversor DCA compra $100 de ETH cada semana durante 52 semanas.", "Un inversor hace DCA de $200/mes en un nuevo altcoin durante 24 meses."], checklist: ["Antes de implementar una estrategia DCA, define: el capital total que estás dispuesto a comprometer, el período durante el cual invertirás, la frecuencia de las compras y las condiciones bajo las que te desviarías del plan.", "Calcula tu punto de equilibrio DCA."], mistakes: ["Confundir el DCA con una garantía de retornos positivos.", "Abandonar la estrategia DCA durante las caídas del mercado cuando es más ventajosa."], benchmarks: ["Rendimiento histórico del DCA vs. suma global: en períodos de inversión de Bitcoin de 10 años en curso, el DCA (compras mensuales) tuvo un rendimiento inferior al de suma global en el 60% de los escenarios en un mercado en alza.", "Optimización de la frecuencia de DCA: el DCA mensual produce el 85%–90% del beneficio de reducción de varianza del DCA semanal."], execution: ["Automatiza la ejecución del DCA a través de las funciones de compra recurrente del exchange, bots DCA de protocolos DeFi o recordatorios basados en calendario con ejecución manual.", "Revisa y potencialmente aumenta los montos de DCA durante caídas severas del mercado."], hygiene: ["Rastrea las métricas de rendimiento del DCA mensualmente.", "Establece una fecha de revisión del DCA al punto final de la estrategia planificada."], validation: ["Verifica tu costo base promedio calculado multiplicando cada compra histórica (cantidad × precio) y dividiendo el costo total por la cantidad total.", "Compara tus retornos reales de DCA con el retorno teórico de suma global para el mismo período."] },
    pt: { interpret: ["Os resultados do cálculo de DCA (média de custo em dólares) mostram o custo base médio alcançado ao distribuir compras ao longo do tempo.", "O poder do DCA torna-se mais aparente durante mercados de baixa."], scenarios: ["Um investidor DCA compra $100 de ETH a cada semana por 52 semanas.", "Um investidor faz DCA de $200/mês em um novo altcoin por 24 meses."], checklist: ["Antes de implementar uma estratégia DCA, defina: o capital total que você está disposto a comprometer, o período durante o qual investirá, a frequência das compras e as condições sob as quais desviaria do plano.", "Calcule seu ponto de equilíbrio DCA."], mistakes: ["Confundir DCA com garantia de retornos positivos.", "Abandonar a estratégia DCA durante quedas de mercado quando é mais vantajosa."], benchmarks: ["Desempenho histórico do DCA vs. soma total: em períodos de investimento em Bitcoin de 10 anos, o DCA (compras mensais) teve desempenho inferior ao de soma total em 60% dos cenários em mercado em alta.", "Otimização de frequência DCA: o DCA mensal produz 85%–90% do benefício de redução de variância do DCA semanal."], execution: ["Automatize a execução do DCA por meio de recursos de compra recorrente de exchange, bots DCA de protocolo DeFi ou lembretes baseados em calendário.", "Revise e potencialmente aumente os valores de DCA durante quedas severas de mercado."], hygiene: ["Rastreie as métricas de desempenho do DCA mensalmente.", "Defina uma data de revisão do DCA no ponto final da estratégia planejada."], validation: ["Verifique seu custo base médio calculado multiplicando cada compra histórica (quantidade × preço) e dividindo o custo total pela quantidade total.", "Compare seus retornos reais de DCA com o retorno teórico de soma total para o mesmo período."] },
    tr: { interpret: ["DCA (dolar maliyet ortalaması) hesaplama sonuçları, satın almaları zaman içine yayarak elde edilen ortalama maliyet tabanını gösterir.", "DCA'nın gücü, en çok ayı piyasalarında belirginleşir."], scenarios: ["Bir DCA yatırımcısı 52 hafta boyunca her hafta 100 dolar ETH satın alıyor.", "Bir yatırımcı 24 ay boyunca yeni bir altcoin'e aylık 200 dolar DCA yapıyor."], checklist: ["Bir DCA stratejisi uygulamadan önce şunları tanımlayın: taahhüt etmeye istekli olduğunuz toplam sermaye, yatırım yapacağınız süre, satın alma sıklığı ve plandan sapacağınız tetikleyici koşullar.", "DCA başabaş noktanızı hesaplayın."], mistakes: ["DCA'yı pozitif getiri garantisiyle karıştırmak.", "DCA stratejisini en avantajlı olduğu piyasa düşüşlerinde terk etmek."], benchmarks: ["Tarihsel DCA performansı vs. toplu ödeme: 10 yıllık kayan Bitcoin yatırım dönemlerinde DCA (aylık satın almalar) yükselen piyasadaki senaryoların %60'ında toplu ödemeden daha düşük performans gösterdi.", "DCA sıklığı optimizasyonu: aylık DCA, haftalık DCA'nın varyans azaltma faydasının %85–%90'ını üretir."], execution: ["DCA yürütmesini exchange yinelenen satın alma özellikleri, DeFi protokol DCA botları veya takvim tabanlı hatırlatıcılar aracılığıyla otomatikleştirin.", "Şiddetli piyasa düşüşleri sırasında DCA miktarlarını gözden geçirin ve potansiyel olarak artırın."], hygiene: ["DCA performans metriklerini aylık olarak takip edin.", "Planlanan strateji bitiş noktasında bir DCA gözden geçirme tarihi belirleyin."], validation: ["Her tarihsel satın almayı (miktar × fiyat) çarparak ve toplam maliyeti toplam miktara bölerek hesaplanan ortalama maliyet tabanınızı doğrulayın.", "Gerçek DCA getirilerinizi aynı dönem için teorik toplu ödeme getirisiyle karşılaştırın."] },
    hi: { interpret: ["DCA (डॉलर-कॉस्ट एवरेजिंग) गणना परिणाम आपको समय के साथ खरीद फैलाकर प्राप्त औसत लागत आधार दिखाते हैं।", "DCA की शक्ति बेयर मार्केट में सबसे स्पष्ट हो जाती है।"], scenarios: ["एक DCA निवेशक 52 हफ्तों के लिए हर हफ्ते $100 ETH खरीदता है।", "एक निवेशक 24 महीनों के लिए एक नई ऑल्टकॉइन में $200/माह DCA करता है।"], checklist: ["DCA रणनीति लागू करने से पहले परिभाषित करें: आप कितनी पूंजी लगाने के इच्छुक हैं, किस अवधि में निवेश करेंगे, खरीद की आवृत्ति और योजना से विचलित होने की ट्रिगर शर्तें।", "अपना DCA ब्रेक-ईवन गणना करें।"], mistakes: ["DCA को सकारात्मक रिटर्न की गारंटी के साथ भ्रमित करना।", "बाजार में गिरावट के दौरान DCA रणनीति को छोड़ना जब यह सबसे फायदेमंद होती है।"], benchmarks: ["ऐतिहासिक DCA प्रदर्शन बनाम एकमुश्त: 10 वर्ष के रोलिंग Bitcoin निवेश अवधि में DCA (मासिक खरीद) बढ़ते बाजार में 60% परिदृश्यों में एकमुश्त से कम प्रदर्शन करता है।", "DCA आवृत्ति अनुकूलन: मासिक DCA साप्ताहिक DCA के विचरण कटौती लाभ का 85%–90% उत्पन्न करता है।"], execution: ["एक्सचेंज आवर्ती खरीद सुविधाओं, DeFi प्रोटोकॉल DCA बॉट्स, या कैलेंडर-आधारित अनुस्मारक के माध्यम से DCA निष्पादन को स्वचालित करें।", "गंभीर बाजार गिरावट के दौरान DCA राशि की समीक्षा करें और संभावित रूप से बढ़ाएं।"], hygiene: ["DCA प्रदर्शन मेट्रिक्स को मासिक रूप से ट्रैक करें।", "नियोजित रणनीति के अंत बिंदु पर DCA समीक्षा तिथि निर्धारित करें।"], validation: ["प्रत्येक ऐतिहासिक खरीद (मात्रा × मूल्य) को गुणा करके और कुल लागत को कुल मात्रा से विभाजित करके अपने गणना किए गए औसत लागत आधार को सत्यापित करें।", "उसी अवधि के लिए अपने वास्तविक DCA रिटर्न की तुलना सैद्धांतिक एकमुश्त रिटर्न से करें।"] },
    ru: { interpret: ["Результаты расчёта DCA (усреднение стоимости в долларах) показывают среднюю базу стоимости, достигнутую путём распределения покупок во времени.", "Сила DCA становится наиболее очевидной в медвежьих рынках."], scenarios: ["DCA-инвестор покупает ETH на $100 каждую неделю в течение 52 недель.", "Инвестор делает DCA на $200/месяц в новый альткоин в течение 24 месяцев."], checklist: ["Перед внедрением стратегии DCA определите: общий капитал, который готовы вложить, период инвестирования, частоту покупок и условия отклонения от плана.", "Рассчитайте точку безубыточности DCA."], mistakes: ["Отождествление DCA с гарантией положительной доходности.", "Отказ от стратегии DCA во время рыночных спадов — именно тогда, когда она наиболее выгодна."], benchmarks: ["Исторические результаты DCA против единовременной суммы: в скользящих 10-летних периодах инвестирования в Bitcoin DCA (ежемесячные покупки) уступало единовременным инвестициям в 60% сценариев растущего рынка.", "Оптимизация частоты DCA: ежемесячный DCA обеспечивает 85–90% эффекта снижения дисперсии еженедельного DCA."], execution: ["Автоматизируйте исполнение DCA через функцию повторяющихся покупок на бирже, DCA-боты DeFi-протоколов или напоминания в календаре.", "Пересматривайте и при возможности увеличивайте суммы DCA в периоды серьёзных рыночных падений."], hygiene: ["Ежемесячно отслеживайте метрики эффективности DCA.", "Установите дату пересмотра DCA по достижении запланированного конца стратегии."], validation: ["Проверяйте рассчитанную среднюю базу стоимости, умножая каждую историческую покупку (количество × цена) и деля общую стоимость на общее количество.", "Сравнивайте фактическую доходность DCA с теоретической доходностью единовременной суммы за тот же период."] }
  },
  'break-even': {
    en: {
      interpret: ["Break-even calculations determine the price at which your total costs (purchase price plus all transaction and holding fees) are fully recovered by your investment's market value. This threshold is critical for trade planning because it sets the minimum price movement required for a trade to become profitable — and reveals whether current market conditions make profitability realistically achievable within your intended holding period. A break-even that requires 15% price appreciation to achieve while the asset has averaged 8% monthly movement means profitability typically takes 6–8 weeks of favorable trend.", "The break-even price in crypto trading must account for all cost layers: your average purchase cost, any exchange fees paid on entry, funding rates if using leverage, potential exit fees, estimated gas costs for DeFi positions, and expected slippage on exit. Many traders calculate a naive break-even based on entry price alone, then discover they're actually still underwater after a 5% price increase because fees consumed most of the apparent gain. Comprehensive break-even calculations eliminate this surprise."],
      scenarios: ["A trader buys $10,000 of BTC at $50,000/BTC. Costs incurred: 0.1% entry fee = $10, expected 0.1% exit fee = $10 (at similar price). Break-even price: $50,000 × (1 + 0.002) = $50,100 — only 0.2% above entry. This is a tight break-even reflecting low exchange fees. Now add a $50 monthly futures funding rate for a 3-month hold: total funding = $150. New break-even: ($10,000 + $170) / 0.2 BTC = $50,850 — now requiring 1.7% appreciation just to break even. The funding rate has a significant impact on leveraged position break-evens.", "A DeFi liquidity provider enters an ETH/USDC pool with $20,000. Transaction costs: $50 gas + 0.3% entry swap fee = $60 + $50 = $110. Expected exit costs: similar $110. Minimum daily fee income needed to break even on a 30-day position: ($110 + $110) / 30 = $7.33/day. At 0.3% pool fee and $500,000 daily volume, LP's share = $20,000/$2,000,000 (pool size) × $1,500 = $15/day. Break-even is comfortably exceeded. But if volume drops 50%, income = $7.50/day — barely above break-even, and impermanent loss risk could push the position underwater."],
      checklist: ["Calculate your complete break-even for every new position: (1) entry price including fees, (2) expected exit costs at current fee rates, (3) carrying costs (funding rates, interest, gas for maintenance actions) for your intended holding period, (4) expected slippage on exit for your position size. Sum all costs and calculate the price appreciation required to cover them. This number should guide your price targets and profit-taking decisions.", "Calculate break-even separately for different exit scenarios: best-case exit (limit order fills at target), average case (market order with normal slippage), worst-case exit (market sell during low liquidity with 2x normal slippage). The break-even price should be achievable in the average scenario, not just the best case. If the average-case break-even requires 20%+ price appreciation, the trade has negative expected value under realistic assumptions."],
      mistakes: ["Calculating break-even only in percentage terms without accounting for position size. A 1% break-even on a $100 position ($1 profit needed) is trivially achievable, while 1% on a $1,000,000 position ($10,000 profit needed) requires much more certainty about execution quality. Always translate percentage break-even to absolute dollar amounts and verify they're consistent with the liquidity available at your target price.", "Excluding opportunity cost from break-even calculations. If you lock $50,000 into a crypto position for 6 months, the break-even analysis should include the return you forgo on alternative investments. At a 5% risk-free rate, $50,000 × 0.05 × 0.5 years = $1,250 opportunity cost. Your true break-even must exceed not just direct trading costs but also the implicit opportunity cost of capital — ensuring the position is profitable relative to simply holding stablecoins."],
      benchmarks: ["Break-even cost structures by trading approach: Spot CEX trading at 0.1% fees: break-even requires 0.2% price movement (entry + exit). Spot DEX trading at 0.3% fee + gas: break-even requires 0.8%–1.5% movement. Leveraged perpetuals at 0.1% fee + 0.03% daily funding: break-even for a 30-day hold requires 1.8%–2.5% movement. DeFi LP position with entry/exit gas: break-even requires 2–5 days of fee income depending on pool volume. Understanding these baselines helps set realistic expectations for each trading approach.", "The break-even threshold's importance relative to market volatility: if an asset moves 3%–5% daily on average, a break-even requiring 2% appreciation is typically achieved within 1–3 trading days — very favorable. If daily volatility is 1%, the same 2% break-even may take 5–10 days and is more exposed to adverse price moves during the achievement period. Match break-even analysis to the asset's realized volatility to assess timing realism."],
      execution: ["Use break-even price as your minimum profit-taking trigger. Set a limit sell order at your calculated break-even price the moment you enter a position — this ensures you exit at the minimum acceptable level if the market briefly touches that price before reversing. Then set a second order at your actual profit target. This two-order structure guarantees you never lose more than transaction costs on any single trade that moves in your direction.", "For DeFi positions, recalculate break-even monthly as carrying costs accumulate and the break-even moves upward. A position entered with a break-even at $50,000 in month one might have a break-even of $50,800 by month three after accumulated funding payments. Tracking this moving break-even ensures you know exactly what price you need for full cost recovery at any point in the holding period."],
      hygiene: ["Maintain a break-even log for all open positions: entry price, all cost components, current break-even threshold, and days elapsed in position. Review this log weekly. As time passes and carrying costs accumulate, the break-even moves upward — tracking this drift reveals when a long-held position that hasn't moved is becoming increasingly expensive to hold relative to the required recovery price.", "After closing positions, compare your actual exit price to your pre-trade break-even calculation. Did you correctly account for all costs? Were there surprise costs (unexpected slippage, fee tier changes, protocol exit costs) that moved the real break-even above your estimate? Building this accuracy feedback loop improves future break-even estimates and reveals systematic cost components you consistently underestimate."],
      validation: ["Verify break-even calculations by running a hypothetical scenario: if the asset hits exactly your calculated break-even price and you exit at that price, sum up all costs paid (entry fees + carrying costs + exit fees + slippage) and confirm they equal the theoretical profit at break-even price. If the math doesn't close to zero P&L, you've missed a cost component in your calculation.", "Test break-even calculations against historical closed positions. Take 5–10 of your recent closed trades and recalculate what the break-even should have been, then compare to your actual profit/loss. If you consistently show profit when you expected zero (break-even), you're underestimating costs and leaving money on the table by exiting too early. If you consistently show losses at expected break-even, you're underestimating costs — a critical calibration issue."]
    },
    es: { interpret: ["Los cálculos de punto de equilibrio determinan el precio al que se recuperan completamente tus costos totales por el valor de mercado de tu inversión.", "El precio de equilibrio en el trading de cripto debe tener en cuenta todas las capas de costos."], scenarios: ["Un trader compra $10,000 de BTC a $50,000/BTC.", "Un proveedor de liquidez DeFi ingresa a un pool ETH/USDC con $20,000."], checklist: ["Calcula tu punto de equilibrio completo para cada nueva posición.", "Calcula el punto de equilibrio por separado para diferentes escenarios de salida."], mistakes: ["Calcular el punto de equilibrio solo en términos porcentuales sin tener en cuenta el tamaño de la posición.", "Excluir el costo de oportunidad de los cálculos de punto de equilibrio."], benchmarks: ["Estructuras de costo de punto de equilibrio por enfoque de trading.", "La importancia del umbral de punto de equilibrio relativo a la volatilidad del mercado."], execution: ["Usa el precio de equilibrio como tu disparador mínimo de toma de ganancias.", "Para posiciones DeFi, recalcula el punto de equilibrio mensualmente a medida que se acumulan los costos de mantenimiento."], hygiene: ["Mantén un registro de punto de equilibrio para todas las posiciones abiertas.", "Después de cerrar posiciones, compara tu precio de salida real con tu cálculo de punto de equilibrio previo al trading."], validation: ["Verifica los cálculos de punto de equilibrio ejecutando un escenario hipotético.", "Prueba los cálculos de punto de equilibrio contra posiciones cerradas históricas."] },
    pt: { interpret: ["Os cálculos de ponto de equilíbrio determinam o preço no qual seus custos totais são totalmente recuperados pelo valor de mercado do seu investimento.", "O preço de equilíbrio no trading de cripto deve levar em conta todas as camadas de custos."], scenarios: ["Um trader compra $10.000 de BTC a $50.000/BTC.", "Um provedor de liquidez DeFi entra em um pool ETH/USDC com $20.000."], checklist: ["Calcule seu ponto de equilíbrio completo para cada nova posição.", "Calcule o ponto de equilíbrio separadamente para diferentes cenários de saída."], mistakes: ["Calcular o ponto de equilíbrio apenas em termos percentuais sem levar em conta o tamanho da posição.", "Excluir o custo de oportunidade dos cálculos de ponto de equilíbrio."], benchmarks: ["Estruturas de custo de ponto de equilíbrio por abordagem de trading.", "A importância do limite de ponto de equilíbrio relativo à volatilidade do mercado."], execution: ["Use o preço de equilíbrio como seu gatilho mínimo de realização de lucros.", "Para posições DeFi, recalcule o ponto de equilíbrio mensalmente à medida que os custos de carregamento se acumulam."], hygiene: ["Mantenha um registro de ponto de equilíbrio para todas as posições abertas.", "Após fechar posições, compare seu preço de saída real com seu cálculo de ponto de equilíbrio pré-negociação."], validation: ["Verifique os cálculos de ponto de equilíbrio executando um cenário hipotético.", "Teste os cálculos de ponto de equilíbrio contra posições fechadas históricas."] },
    tr: { interpret: ["Başabaş hesaplamaları, toplam maliyetlerinizin yatırımınızın piyasa değeri tarafından tamamen geri kazanıldığı fiyatı belirler.", "Kripto işlemlerinde başabaş fiyatı, tüm maliyet katmanlarını hesaba katmalıdır."], scenarios: ["Bir trader, BTC'yi 50.000 dolar/BTC'den 10.000 dolara satın alıyor.", "Bir DeFi likidite sağlayıcısı, 20.000 dolar ile bir ETH/USDC havuzuna giriyor."], checklist: ["Her yeni pozisyon için tam başabaş noktanızı hesaplayın.", "Farklı çıkış senaryoları için başabaş noktasını ayrı ayrı hesaplayın."], mistakes: ["Başabaş noktasını pozisyon büyüklüğünü hesaba katmadan yalnızca yüzde cinsinden hesaplamak.", "Fırsat maliyetini başabaş hesaplamalarından dışlamak."], benchmarks: ["İşlem yaklaşımına göre başabaş maliyet yapıları.", "Piyasa oynaklığına göre başabaş eşiğinin önemi."], execution: ["Başabaş fiyatını minimum kâr alma tetikleyiciniz olarak kullanın.", "DeFi pozisyonları için, taşıma maliyetleri birikmesi nedeniyle başabaş noktasını aylık olarak yeniden hesaplayın."], hygiene: ["Tüm açık pozisyonlar için bir başabaş kaydı tutun.", "Pozisyonları kapattıktan sonra, gerçek çıkış fiyatınızı işlem öncesi başabaş hesaplamanızla karşılaştırın."], validation: ["Başabaş hesaplamalarını hipotetik bir senaryo çalıştırarak doğrulayın.", "Başabaş hesaplamalarını tarihsel kapatılmış pozisyonlara karşı test edin."] },
    hi: { interpret: ["ब्रेक-ईवन गणनाएं वह मूल्य निर्धारित करती हैं जिस पर आपकी कुल लागत निवेश के बाजार मूल्य द्वारा पूरी तरह से वसूल हो जाती है।", "क्रिप्टो ट्रेडिंग में ब्रेक-ईवन मूल्य को सभी लागत परतों का हिसाब देना होगा।"], scenarios: ["एक ट्रेडर $50,000/BTC पर $10,000 का BTC खरीदता है।", "एक DeFi लिक्विडिटी प्रदाता $20,000 के साथ ETH/USDC पूल में प्रवेश करता है।"], checklist: ["प्रत्येक नई पोजीशन के लिए अपना पूर्ण ब्रेक-ईवन गणना करें।", "विभिन्न निकास परिदृश्यों के लिए ब्रेक-ईवन अलग से गणना करें।"], mistakes: ["पोजीशन आकार का हिसाब किए बिना केवल प्रतिशत शब्दों में ब्रेक-ईवन गणना करना।", "ब्रेक-ईवन गणना से अवसर लागत को बाहर करना।"], benchmarks: ["ट्रेडिंग दृष्टिकोण के अनुसार ब्रेक-ईवन लागत संरचनाएं।", "बाजार अस्थिरता के सापेक्ष ब्रेक-ईवन थ्रेशोल्ड का महत्व।"], execution: ["ब्रेक-ईवन मूल्य को अपने न्यूनतम लाभ-लेने ट्रिगर के रूप में उपयोग करें।", "DeFi पोजीशन के लिए, जैसे-जैसे कैरींग लागतें जमा होती हैं, ब्रेक-ईवन की मासिक पुनर्गणना करें।"], hygiene: ["सभी खुली पोजीशन के लिए ब्रेक-ईवन लॉग बनाए रखें।", "पोजीशन बंद करने के बाद, वास्तविक निकास मूल्य को अपनी पूर्व-ट्रेड ब्रेक-ईवन गणना से तुलना करें।"], validation: ["एक काल्पनिक परिदृश्य चलाकर ब्रेक-ईवन गणनाओं को सत्यापित करें।", "ऐतिहासिक बंद पोजीशन के खिलाफ ब्रेक-ईवन गणनाओं का परीक्षण करें।"] },
    ru: { interpret: ["Расчёты точки безубыточности определяют цену, при которой ваши совокупные затраты полностью покрываются рыночной стоимостью инвестиций.", "Точка безубыточности в крипто-трейдинге должна учитывать все уровни затрат."], scenarios: ["Трейдер покупает BTC на $10 000 по $50 000/BTC.", "DeFi-провайдер ликвидности входит в пул ETH/USDC с $20 000."], checklist: ["Рассчитайте полную точку безубыточности для каждой новой позиции.", "Рассчитывайте точку безубыточности отдельно для различных сценариев выхода."], mistakes: ["Расчёт точки безубыточности только в процентах без учёта размера позиции.", "Исключение альтернативной стоимости из расчётов точки безубыточности."], benchmarks: ["Структуры затрат точки безубыточности по торговым подходам.", "Важность порога безубыточности относительно рыночной волатильности."], execution: ["Используйте цену безубыточности как минимальный триггер для фиксации прибыли.", "Для позиций DeFi ежемесячно пересчитывайте безубыточность по мере накопления затрат на удержание."], hygiene: ["Ведите журнал безубыточности для всех открытых позиций.", "После закрытия позиций сравнивайте фактическую цену выхода с расчётом безубыточности."], validation: ["Проверяйте расчёты безубыточности, запуская гипотетический сценарий.", "Тестируйте расчёты безубыточности на исторически закрытых позициях."] }
  },

  'position-size': {
    en: {
      interpret: ["Position size calculations determine the optimal dollar amount to allocate to a trade based on your account size, risk tolerance, and the specific trade setup's defined risk parameters. The output — how much to buy — should be understood as a function of how much you're willing to lose, not how much you expect to gain. A position size that creates a maximum loss of 1%–2% of total portfolio value on a single trade provides the mathematical foundation for surviving long losing streaks while preserving capital for eventual recovery.", "The Kelly Criterion and fixed fractional position sizing models both arrive at the same conclusion: the mathematically optimal position size decreases as the probability of a loss increases. In crypto markets with high uncertainty, conservative Kelly fractions (1/4 or 1/8 Kelly rather than full Kelly) typically outperform aggressive position sizing over 50+ trade samples. Consistently oversizing positions is statistically guaranteed to lead to ruin even with a positive expected value strategy."],
      scenarios: ["Account size: $50,000. Risk per trade: 1% = $500. Entry: $2,000. Stop-loss: $1,800 (10% below entry). Risk per unit: $200. Position size: $500 / $200 = 2.5 units. Total position value: 2.5 × $2,000 = $5,000 (10% of account). This 10% position sizing with a 10% stop-loss creates exactly 1% account risk — standard for a risk-managed trade. If stop is hit, you lose $500 (1% of $50,000), not the full $5,000.", "A trend follower's setup: $100,000 account, 0.5% risk per trade, entry at $0.50, stop at $0.35 (30% below). Risk per unit: $0.15. Dollar risk: $100,000 × 0.005 = $500. Position size: $500 / $0.15 = 3,333 units. Total position: 3,333 × $0.50 = $1,666 (1.7% of account). The wide stop (30%) means a small position — deliberately small because the uncertainty is high. If the stop triggers, $500 is lost (0.5%), leaving $99,500 for subsequent trades."],
      checklist: ["Before every trade, define your stop-loss level based on technical invalidation — not on percentage targets. The stop should be placed at the price that proves your trade thesis wrong, not at an arbitrary round-number distance from entry. Once the stop is defined, work backward to determine position size using your risk percentage. This 'thesis-first, size-second' approach ensures position sizing is connected to trade logic rather than independent of it.", "Calculate your maximum concurrent position risk: if you're running 10 simultaneous positions each with 1% account risk, a correlated market crash that hits all stops simultaneously creates 10% total drawdown in a single day. High correlation between positions multiplies the effective single-event risk. During periods of extreme market uncertainty, consider reducing total concurrent risk to 3%–5% of account regardless of individual position sizes."],
      mistakes: ["Ignoring correlations when sizing a portfolio of positions. Buying 10 different altcoins with 2% risk each feels diversified, but if all 10 are highly correlated with Bitcoin (as most are), you're effectively running 20% risk on a single Bitcoin directional bet. Correlation-adjusted position sizing reduces individual position sizes when adding assets that move together, maintaining truly diversified total risk across the portfolio.", "Increasing position size after winning streaks and decreasing after losing streaks — the opposite of what math recommends. Winning streaks are often followed by regression to the mean, making larger positions more dangerous. Losing streaks often represent temporary statistical variance that larger positions during recovery would magnify the losses on. Keep position sizes consistent based on account size and defined risk rules, not recent performance."],
      benchmarks: ["Professional crypto fund position sizing standards: maximum single position 5%–10% of portfolio, maximum sector exposure 30%–40%, maximum correlated risk in any single scenario 10%–15%. Retail traders who exceed these thresholds show significantly higher account drawdown volatility without proportional return improvement — the excess concentration creates tail risk that periodically causes catastrophic drawdowns.", "Kelly Criterion optimal bet fractions for crypto trading: with 55% win rate and 1.5:1 reward-risk ratio, full Kelly recommends 16.7% position size. Quarter-Kelly (4.2%) is often recommended as more practical, limiting the compounding risk of model uncertainty. Studies of crypto traders show that those using fixed 1%–2% risk per trade significantly outperform those using variable/intuitive position sizing over 500+ trade samples."],
      execution: ["Implement position sizing before the market opens, not in real-time while watching price action. Pre-calculating position sizes based on planned entry and stop-loss levels removes the emotional pressure of in-the-moment calculations. Create a simple position size calculator spreadsheet that you reference before every trade. Input: account size, risk %, entry price, stop price. Output: maximum position size in units and dollars.", "Adjust position size for setup quality. Not every trade setup is created equal — a setup with multiple technical confirmations (breakout, volume, trend alignment, fundamental catalyst) might justify 1.5% risk, while a speculative setup with minimal confirmation should be sized at 0.5% or less. Creating quality tiers (A/B/C setups) with corresponding risk allocations (1.5%, 1.0%, 0.5%) implements systematic quality discrimination in position sizing."],
      hygiene: ["Record every trade's position size, defined risk amount, and maximum drawdown reached. After 50+ trades, analyze whether your wins and losses are consistent with your risk-per-trade targets. If your average loss is 1.5% but you targeted 1%, either stops are placed too loosely or position sizes are too large. This empirical calibration of position sizing over many trades provides ground truth that improves future accuracy.", "Review position sizing rules every 3 months as your account grows or shrinks. If your account grows 50%, your 1% risk in dollar terms grows proportionally — your absolute dollar risk per trade automatically increases, which may require adjusting to maintain consistent leverage. Conversely, after significant drawdowns, consider reducing the risk percentage temporarily to limit further damage while the account recovers."],
      validation: ["After any trade that hits your stop-loss, verify that the actual dollar loss equals your pre-trade risk calculation. If actual loss consistently exceeds calculated risk, identify why: slippage beyond expectation, stop-loss not executed at planned price, or calculation errors. Position sizing theory only works if execution matches the model — gaps between modeled and realized risk require immediate investigation.", "Backtest your position sizing rules using historical trade data. Take your last 20 trades and apply your current position sizing rules to see what the results would have been. If applying consistent 1% risk produces materially different returns than your actual trading history, you've been position sizing inconsistently — the backtest reveals the gap between intended and actual practice."]
    },
    es: { interpret: ["Los cálculos de tamaño de posición determinan la cantidad en dólares óptima a asignar a una operación según el tamaño de tu cuenta, la tolerancia al riesgo y los parámetros de riesgo definidos de la configuración específica.", "El Criterio de Kelly y los modelos de dimensionamiento de posición fraccionaria fija llegan a la misma conclusión."], scenarios: ["Tamaño de cuenta: $50,000. Riesgo por operación: 1% = $500. Entrada: $2,000. Stop-loss: $1,800.", "Un seguidor de tendencias: cuenta de $100,000, 0.5% de riesgo por operación, entrada a $0.50, stop a $0.35."], checklist: ["Antes de cada operación, define tu nivel de stop-loss basado en la invalidación técnica.", "Calcula tu riesgo máximo de posición concurrente."], mistakes: ["Ignorar las correlaciones al dimensionar una cartera de posiciones.", "Aumentar el tamaño de posición después de rachas ganadoras y disminuir después de rachas perdedoras."], benchmarks: ["Estándares de dimensionamiento de posición de fondos cripto profesionales.", "Fracciones de apuesta óptimas del Criterio de Kelly para el trading de cripto."], execution: ["Implementa el dimensionamiento de posición antes de que el mercado abra, no en tiempo real.", "Ajusta el tamaño de posición según la calidad de configuración."], hygiene: ["Registra el tamaño de posición, el monto de riesgo definido y el máximo drawdown alcanzado de cada operación.", "Revisa las reglas de dimensionamiento de posición cada 3 meses."], validation: ["Después de cualquier operación que alcance tu stop-loss, verifica que la pérdida real en dólares sea igual a tu cálculo de riesgo previo a la operación.", "Realiza backtesting de tus reglas de dimensionamiento de posición usando datos de operaciones históricas."] },
    pt: { interpret: ["Os cálculos de tamanho de posição determinam o valor em dólares ideal a alocar para uma negociação com base no tamanho da sua conta, tolerância ao risco e parâmetros de risco definidos da configuração específica.", "O Critério de Kelly e os modelos de dimensionamento de posição fraccionário fixo chegam à mesma conclusão."], scenarios: ["Tamanho da conta: $50.000. Risco por negociação: 1% = $500. Entrada: $2.000. Stop-loss: $1.800.", "Um seguidor de tendência: conta de $100.000, 0,5% de risco por negociação, entrada a $0,50, stop a $0,35."], checklist: ["Antes de cada negociação, defina seu nível de stop-loss com base na invalidação técnica.", "Calcule seu risco máximo de posição concorrente."], mistakes: ["Ignorar correlações ao dimensionar um portfólio de posições.", "Aumentar o tamanho da posição após sequências de vitórias e diminuir após sequências de perdas."], benchmarks: ["Padrões de dimensionamento de posição de fundos cripto profissionais.", "Frações de aposta ótimas do Critério de Kelly para trading de cripto."], execution: ["Implemente o dimensionamento de posição antes da abertura do mercado, não em tempo real.", "Ajuste o tamanho da posição para a qualidade da configuração."], hygiene: ["Registre o tamanho de posição de cada negociação, o valor de risco definido e o drawdown máximo atingido.", "Revise as regras de dimensionamento de posição a cada 3 meses."], validation: ["Após qualquer negociação que atinja seu stop-loss, verifique se a perda real em dólares é igual ao seu cálculo de risco pré-negociação.", "Faça backtest de suas regras de dimensionamento de posição usando dados históricos de negociações."] },
    tr: { interpret: ["Pozisyon büyüklüğü hesaplamaları, hesap büyüklüğünüz, risk toleransınız ve belirli işlem düzenlemesinin tanımlanmış risk parametrelerine dayanarak bir işleme tahsis edilecek optimum dolar miktarını belirler.", "Kelly Kriteri ve sabit fraksiyonel pozisyon boyutlandırma modelleri aynı sonuca varır."], scenarios: ["Hesap büyüklüğü: 50.000 dolar. İşlem başına risk: %1 = 500 dolar. Giriş: 2.000 dolar. Stop-loss: 1.800 dolar.", "Bir trend takipçisinin kurulumu: 100.000 dolarlık hesap, işlem başına %0,5 risk, 0,50 dolardan giriş, 0,35 dolardan stop."], checklist: ["Her işlemden önce, stop-loss seviyenizi teknik geçersizleştirme temelinde tanımlayın.", "Maksimum eşzamanlı pozisyon riskinizi hesaplayın."], mistakes: ["Pozisyon portföyünü boyutlandırırken korelasyonları görmezden gelmek.", "Kazanma serilerinden sonra pozisyon büyüklüğünü artırmak ve kayıp serilerinden sonra azaltmak."], benchmarks: ["Profesyonel kripto fon pozisyon boyutlandırma standartları.", "Kripto işlemler için Kelly Kriteri optimal bahis kesirleri."], execution: ["Pozisyon boyutlandırmayı piyasa açılmadan önce, gerçek zamanlı değil, uygulayın.", "Kurulum kalitesine göre pozisyon büyüklüğünü ayarlayın."], hygiene: ["Her işlemin pozisyon büyüklüğünü, tanımlanan risk miktarını ve ulaşılan maksimum düşüşü kaydedin.", "Hesap büyüyüp küçüldükçe pozisyon boyutlandırma kurallarını 3 ayda bir gözden geçirin."], validation: ["Stop-loss'a çarpan herhangi bir işlemden sonra, gerçek dolar kaybının işlem öncesi risk hesaplamanıza eşit olduğunu doğrulayın.", "Pozisyon boyutlandırma kurallarınızı tarihsel işlem verilerini kullanarak geri test edin."] },
    hi: { interpret: ["पोजीशन साइज़ गणनाएं आपके खाते के आकार, जोखिम सहनशीलता और विशिष्ट ट्रेड सेटअप के परिभाषित जोखिम मापदंडों के आधार पर एक ट्रेड को आवंटित करने के लिए इष्टतम डॉलर राशि निर्धारित करती हैं।", "केली मानदंड और स्थिर अंशीय पोजीशन साइजिंग मॉडल दोनों एक ही निष्कर्ष पर पहुंचते हैं।"], scenarios: ["खाते का आकार: $50,000। प्रति ट्रेड जोखिम: 1% = $500। प्रवेश: $2,000। स्टॉप-लॉस: $1,800।", "एक ट्रेंड फॉलोअर का सेटअप: $100,000 खाता, प्रति ट्रेड 0.5% जोखिम, $0.50 पर प्रवेश, $0.35 पर स्टॉप।"], checklist: ["प्रत्येक ट्रेड से पहले, तकनीकी अमान्यता के आधार पर अपना स्टॉप-लॉस स्तर परिभाषित करें।", "अपना अधिकतम एक साथ पोजीशन जोखिम गणना करें।"], mistakes: ["पोजीशन के पोर्टफोलियो को साइज़ करते समय सहसंबंधों को नजरअंदाज करना।", "जीतने की लकीरों के बाद पोजीशन साइज़ बढ़ाना और हारने की लकीरों के बाद घटाना।"], benchmarks: ["पेशेवर क्रिप्टो फंड पोजीशन साइजिंग मानक।", "क्रिप्टो ट्रेडिंग के लिए केली मानदंड के इष्टतम बेट फ्रेक्शन।"], execution: ["पोजीशन साइजिंग बाजार खुलने से पहले लागू करें, रीयल-टाइम में नहीं।", "सेटअप गुणवत्ता के लिए पोजीशन साइज़ समायोजित करें।"], hygiene: ["प्रत्येक ट्रेड के पोजीशन साइज़, परिभाषित जोखिम राशि और अधिकतम ड्रॉडाउन का रिकॉर्ड करें।", "हर 3 महीने में पोजीशन साइजिंग नियमों की समीक्षा करें।"], validation: ["स्टॉप-लॉस हिट करने वाले किसी भी ट्रेड के बाद, सत्यापित करें कि वास्तविक डॉलर हानि आपकी पूर्व-ट्रेड जोखिम गणना के बराबर है।", "ऐतिहासिक ट्रेड डेटा का उपयोग करके अपने पोजीशन साइजिंग नियमों का बैकटेस्ट करें।"] },
    ru: { interpret: ["Расчёты размера позиции определяют оптимальную сумму в долларах для выделения на сделку, исходя из размера счёта, допустимого риска и параметров конкретной торговой установки.", "Критерий Келли и модели фиксированного дробного размера позиции приходят к одному выводу."], scenarios: ["Размер счёта: $50 000. Риск на сделку: 1% = $500. Вход: $2 000. Стоп-лосс: $1 800.", "Трендовый трейдер: счёт $100 000, риск 0,5% на сделку, вход по $0,50, стоп по $0,35."], checklist: ["Перед каждой сделкой определяйте уровень стоп-лосса на основе технической инвалидации.", "Рассчитывайте максимальный одновременный риск позиций."], mistakes: ["Игнорирование корреляций при формировании портфеля позиций.", "Увеличение размера позиции после серий выигрышей и уменьшение после серий проигрышей."], benchmarks: ["Стандарты размера позиции профессиональных крипто-фондов.", "Оптимальные доли ставки по критерию Келли для криптотрейдинга."], execution: ["Определяйте размер позиций до открытия рынка, а не в режиме реального времени.", "Корректируйте размер позиции в зависимости от качества установки."], hygiene: ["Фиксируйте размер позиции, определённую сумму риска и максимальный просадка каждой сделки.", "Пересматривайте правила размера позиций каждые 3 месяца."], validation: ["После любой сделки, достигшей стоп-лосса, проверяйте, равны ли фактические потери в долларах вашему расчёту риска.", "Проводите бэктест правил размера позиций на исторических данных сделок."] }
  },
  'liquidation-price': {
    en: {
      interpret: ["Liquidation price calculations tell you the exact market price at which your leveraged position will be forcefully closed by the exchange, eliminating your entire margin deposit. This price is not a soft target — it's a hard boundary enforced automatically by the protocol's smart contract or exchange system the moment market price reaches it. Understanding your liquidation price before opening a position is non-negotiable: if you can't articulate exactly where liquidation occurs and why you believe the market won't reach that level within your intended holding period, you haven't adequately risk-managed the position.", "The distance between your entry price and liquidation price is your effective margin buffer. On 10x leverage, this buffer is approximately 10% — the price only needs to move 10% against you for complete loss. On 20x leverage, it's 5%. On 50x leverage, it's 2%. Volatility context is essential: if the asset typically moves 5% in a single day, 10x leverage means a potential liquidation from a single adverse session. Matching leverage ratios to asset volatility — not to desired profit multiples — is the foundation of sound leveraged trading."],
      scenarios: ["Long BTC at $50,000 with 5x leverage and $10,000 margin. Notional position: $50,000. Liquidation formula: entry × (1 - 1/leverage) = $50,000 × (1 - 0.2) = $40,000. BTC must fall 20% ($10,000) to liquidate. At BTC's historical volatility of 5%/day, this represents 4 average daily moves — some protection but vulnerable to a 2-3 day adverse trend. Adding $5,000 additional margin as a buffer raises liquidation to: new margin / (position size × leverage) calculations push it further below $38,000.", "Short ETH at $2,000 with 3x leverage and $5,000 margin. Notional: $15,000. Liquidation price (for short): entry × (1 + 1/leverage) = $2,000 × 1.333 = $2,667. ETH must rise 33% to liquidate. A 33% move in ETH is common over 30-day periods. Maintaining this short for months requires monitoring for news-driven spikes and potentially adding margin if ETH approaches $2,400–$2,500 to prevent liquidation during temporary volatility."],
      checklist: ["Before opening any leveraged position, calculate your liquidation price and verify the following: (1) Is the liquidation price outside your stop-loss range? Your stop should be hit before liquidation, allowing you to exit voluntarily rather than being force-closed. (2) Does the price between liquidation and stop represent a scenario you've analyzed and are comfortable with? (3) Is there sufficient margin buffer (20%–30% above minimum required) to withstand normal volatility without approaching liquidation?", "Calculate partial liquidation scenarios if using cross-margin accounts. In cross-margin mode, profits from other positions can offset the margin requirements of underwater positions — but losses in multiple correlated positions simultaneously can cascade to mutual liquidations. Model the total account scenario: what combination of adverse price movements across all open positions would trigger liquidations, and is that scenario within plausible market conditions?"],
      mistakes: ["Adding margin to a losing position to 'save' it from liquidation without reassessing whether the trade thesis still holds. Each margin addition pushes the liquidation price lower but also increases the total capital at risk if the trend continues. If a position is approaching liquidation, the correct question is 'Should I still be in this trade?' not 'How much margin can I add?' The psychology of avoiding liquidation often leads to compounding a losing trade beyond rational sizing.", "Using maximum available leverage without understanding the liquidation mechanics. Many exchanges offer 100x leverage, implying a 1% adverse move causes liquidation. These extreme leverage settings are almost exclusively used by professional arbitrageurs with microsecond execution hedging the position simultaneously. For directional trading, using more than 10x leverage on any position creates liquidation scenarios that typical market volatility triggers routinely."],
      benchmarks: ["Leverage usage patterns among successful crypto traders: professional quantitative funds typically use 1x–3x for directional crypto positions, scaling to 5x–10x only for arbitrage strategies with near-zero directional risk. Retail traders using leverage above 10x show median account lifespans below 60 days. The mathematics of leverage are unforgiving — even with 55% winning trade rate, 10x leverage eventually liquidates nearly everyone over sufficient time through losing streaks.", "Historical liquidation cascade data: during major crypto crashes (March 2020, May 2021, November 2022), cascading liquidations amplified price movements by 40%–80% beyond what fundamental sellers drove. When $1 billion+ in leveraged long positions liquidates simultaneously, the forced selling creates additional price pressure that triggers further liquidations — the liquidation cascade. High open interest in leveraged longs is a leading indicator of crash amplification risk."],
      execution: ["Set a personal 'margin call zone' — a price level 15%–20% above your calculated liquidation price. When market price enters this zone, take action: either reduce position size, add margin defensively, or exit the position. Waiting until actual liquidation is imminent creates panic-driven decisions at the worst possible price. Acting at your margin call zone preserves choice and timing control.", "Use isolated margin mode for speculative positions rather than cross-margin. Isolated margin limits your maximum loss to the margin allocated to that specific position — if it's liquidated, your other positions and remaining account balance are unaffected. Cross-margin provides more flexibility but creates interconnected risk across all positions. For risk management clarity, isolated margin is almost always preferable for directional positions with defined risk."],
      hygiene: ["Monitor liquidation prices daily for all open leveraged positions. Market price movements continuously change your distance to liquidation — a position that was 20% away from liquidation yesterday might be 8% away today after an adverse move. Track the percentage distance to liquidation as a real-time risk metric, not just the absolute price level. Set price alerts that trigger when any position enters the margin call zone.", "Document all positions that approach within 5% of liquidation, whether they liquidated or you exited voluntarily. This record reveals patterns in how you use leverage — whether you systematically take on more risk than intended, whether certain asset classes consistently approach liquidation, and whether your stop-loss discipline prevents liquidation events or whether stops are too loose to provide protection."],
      validation: ["Verify your liquidation price calculation against the exchange's displayed liquidation price in the position details. If they differ, identify the source of discrepancy: different fee inclusion, maintenance margin rate differences, or a different formula for isolated vs. cross-margin. Always use the exchange's displayed liquidation price as the authoritative figure — your manual calculation should match closely but the exchange's system is definitive.", "Test your liquidation calculations in small-size positions before trading significant capital with leverage. Open a test position at 1% of your intended size, observe the exchange-calculated liquidation price, and verify it matches your formula. This verification ensures your understanding of the exchange's specific liquidation mechanics is correct before committing meaningful capital."]
    },
    es: { interpret: ["Los cálculos de precio de liquidación te indican el precio exacto de mercado al que tu posición apalancada será cerrada a la fuerza por el exchange.", "La distancia entre tu precio de entrada y el precio de liquidación es tu margen de seguridad efectivo."], scenarios: ["Largo en BTC a $50,000 con apalancamiento 5x y $10,000 de margen.", "Corto en ETH a $2,000 con apalancamiento 3x y $5,000 de margen."], checklist: ["Antes de abrir cualquier posición apalancada, calcula tu precio de liquidación y verifica lo siguiente.", "Calcula escenarios de liquidación parcial si usas cuentas de margen cruzado."], mistakes: ["Agregar margen a una posición perdedora para 'salvarla' de la liquidación sin reevaluar si la tesis de la operación sigue siendo válida.", "Usar el máximo apalancamiento disponible sin entender la mecánica de liquidación."], benchmarks: ["Patrones de uso de apalancamiento entre los traders de cripto exitosos.", "Datos históricos de cascada de liquidaciones."], execution: ["Establece una 'zona de llamada de margen' personal — un nivel de precio 15%–20% por encima de tu precio de liquidación calculado.", "Usa el modo de margen aislado para posiciones especulativas en lugar del margen cruzado."], hygiene: ["Monitorea los precios de liquidación diariamente para todas las posiciones apalancadas abiertas.", "Documenta todas las posiciones que se acerquen al 5% de la liquidación."], validation: ["Verifica tu cálculo de precio de liquidación contra el precio de liquidación mostrado por el exchange en los detalles de la posición.", "Prueba tus cálculos de liquidación en posiciones de tamaño pequeño antes de operar con capital significativo con apalancamiento."] },
    pt: { interpret: ["Os cálculos de preço de liquidação informam o preço exato de mercado no qual sua posição alavancada será fechada à força pelo exchange.", "A distância entre seu preço de entrada e o preço de liquidação é sua margem de segurança efetiva."], scenarios: ["Long BTC a $50.000 com 5x alavancagem e $10.000 de margem.", "Short ETH a $2.000 com 3x alavancagem e $5.000 de margem."], checklist: ["Antes de abrir qualquer posição alavancada, calcule seu preço de liquidação e verifique o seguinte.", "Calcule cenários de liquidação parcial se usar contas de margem cruzada."], mistakes: ["Adicionar margem a uma posição perdedora para 'salvá-la' da liquidação sem reavaliar se a tese da negociação ainda é válida.", "Usar a alavancagem máxima disponível sem entender a mecânica de liquidação."], benchmarks: ["Padrões de uso de alavancagem entre traders de cripto bem-sucedidos.", "Dados históricos de cascata de liquidações."], execution: ["Defina uma 'zona de chamada de margem' pessoal — um nível de preço 15%–20% acima do seu preço de liquidação calculado.", "Use o modo de margem isolada para posições especulativas em vez de margem cruzada."], hygiene: ["Monitore os preços de liquidação diariamente para todas as posições alavancadas abertas.", "Documente todas as posições que se aproximam a 5% da liquidação."], validation: ["Verifique seu cálculo de preço de liquidação contra o preço de liquidação exibido pelo exchange nos detalhes da posição.", "Teste seus cálculos de liquidação em posições de tamanho pequeno antes de negociar capital significativo com alavancagem."] },
    tr: { interpret: ["Tasfiye fiyatı hesaplamaları, kaldıraçlı pozisyonunuzun borsa tarafından zorla kapatılacağı tam piyasa fiyatını gösterir.", "Giriş fiyatınız ile tasfiye fiyatınız arasındaki mesafe, efektif marjin tamponunuzdur."], scenarios: ["5x kaldıraç ve 10.000 dolar marjinle BTC'yi 50.000 dolardan uzun.", "3x kaldıraç ve 5.000 dolar marjinle ETH'yi 2.000 dolardan açığa satış."], checklist: ["Herhangi bir kaldıraçlı pozisyon açmadan önce tasfiye fiyatınızı hesaplayın ve şunları doğrulayın.", "Çapraz marjin hesapları kullanıyorsanız kısmi tasfiye senaryolarını hesaplayın."], mistakes: ["İşlem tezinin hala geçerliliğini yeniden değerlendirmeden 'kurtarmak' için kaybeden bir pozisyona marjin eklemek.", "Tasfiye mekaniklerini anlamadan maksimum mevcut kaldıracı kullanmak."], benchmarks: ["Başarılı kripto traderları arasındaki kaldıraç kullanım kalıpları.", "Tarihsel tasfiye çığı verileri."], execution: ["Kişisel bir 'marjin çağrısı bölgesi' belirleyin — hesaplanan tasfiye fiyatınızın %15–%20 üzerinde bir fiyat seviyesi.", "Spekülatif pozisyonlar için çapraz marjin yerine izole marjin modunu kullanın."], hygiene: ["Tüm açık kaldıraçlı pozisyonlar için tasfiye fiyatlarını günlük olarak izleyin.", "Tasfiyeye %5 içinde yaklaşan tüm pozisyonları belgeleyin."], validation: ["Tasfiye fiyatı hesaplamanızı, borsanın pozisyon ayrıntılarında gösterdiği tasfiye fiyatına karşı doğrulayın.", "Önemli sermayeyi kaldıraçla işlem yapmadan önce küçük boyutlu pozisyonlarda tasfiye hesaplamalarınızı test edin."] },
    hi: { interpret: ["लिक्विडेशन मूल्य गणनाएं आपको वह सटीक बाजार मूल्य बताती हैं जिस पर आपकी लीवरेज्ड पोजीशन एक्सचेंज द्वारा जबरदस्ती बंद कर दी जाएगी।", "आपके प्रवेश मूल्य और लिक्विडेशन मूल्य के बीच की दूरी आपका प्रभावी मार्जिन बफर है।"], scenarios: ["5x लीवरेज और $10,000 मार्जिन के साथ $50,000 पर BTC लॉन्ग।", "3x लीवरेज और $5,000 मार्जिन के साथ $2,000 पर ETH शॉर्ट।"], checklist: ["किसी भी लीवरेज्ड पोजीशन खोलने से पहले, अपना लिक्विडेशन मूल्य गणना करें और निम्नलिखित सत्यापित करें।", "क्रॉस-मार्जिन खातों का उपयोग करने पर आंशिक लिक्विडेशन परिदृश्यों की गणना करें।"], mistakes: ["ट्रेड थीसिस अभी भी मान्य है या नहीं का पुनर्मूल्यांकन किए बिना लिक्विडेशन से 'बचाने' के लिए एक हारने वाली पोजीशन में मार्जिन जोड़ना।", "लिक्विडेशन मेकेनिज्म को समझे बिना अधिकतम उपलब्ध लीवरेज का उपयोग करना।"], benchmarks: ["सफल क्रिप्टो ट्रेडर्स के बीच लीवरेज उपयोग पैटर्न।", "ऐतिहासिक लिक्विडेशन कैस्केड डेटा।"], execution: ["एक व्यक्तिगत 'मार्जिन कॉल ज़ोन' सेट करें — गणना किए गए लिक्विडेशन मूल्य से 15%–20% ऊपर एक मूल्य स्तर।", "क्रॉस-मार्जिन के बजाय सट्टा पोजीशन के लिए आइसोलेटेड मार्जिन मोड का उपयोग करें।"], hygiene: ["सभी खुली लीवरेज्ड पोजीशन के लिए लिक्विडेशन मूल्यों की दैनिक निगरानी करें।", "सभी पोजीशन जो लिक्विडेशन के 5% के भीतर आती हैं उन्हें दस्तावेज़ करें।"], validation: ["एक्सचेंज के पोजीशन विवरण में प्रदर्शित लिक्विडेशन मूल्य के खिलाफ अपनी लिक्विडेशन मूल्य गणना सत्यापित करें।", "महत्वपूर्ण पूंजी के साथ लीवरेज ट्रेड करने से पहले छोटे आकार की पोजीशन में अपनी लिक्विडेशन गणनाओं का परीक्षण करें।"] },
    ru: { interpret: ["Расчёты цены ликвидации показывают точную рыночную цену, при которой ваша позиция с кредитным плечом будет принудительно закрыта биржей.", "Расстояние между ценой входа и ценой ликвидации — это ваш эффективный маржинальный буфер."], scenarios: ["Long BTC по $50 000 с плечом 5x и маржей $10 000.", "Short ETH по $2 000 с плечом 3x и маржей $5 000."], checklist: ["Перед открытием любой позиции с плечом рассчитайте цену ликвидации и проверьте следующее.", "Моделируйте сценарии частичной ликвидации при использовании кросс-маржи."], mistakes: ["Пополнение маржи проигрышной позиции для «спасения» от ликвидации без переоценки тезиса сделки.", "Использование максимального доступного плеча без понимания механики ликвидации."], benchmarks: ["Паттерны использования плеча среди успешных крипто-трейдеров.", "Исторические данные о каскадах ликвидаций."], execution: ["Установите личную «зону маржин-колла» — уровень цены на 15–20% выше рассчитанной цены ликвидации.", "Используйте режим изолированной маржи для спекулятивных позиций вместо кросс-маржи."], hygiene: ["Ежедневно отслеживайте цены ликвидации по всем открытым позициям с плечом.", "Документируйте все позиции, приближающиеся к ликвидации в пределах 5%."], validation: ["Проверяйте расчёт цены ликвидации, сверяясь с отображаемой биржей ценой ликвидации в деталях позиции.", "Тестируйте расчёты ликвидации на позициях небольшого размера до торговли значительным капиталом с плечом."] }
  },
  'nft-rarity-price': {
    en: {
      interpret: ["NFT rarity and price analysis requires combining statistical rarity scores with market sentiment factors that purely mathematical models often miss. A trait rarity score tells you how statistically uncommon an NFT's attribute combination is within its collection — but rarity alone doesn't determine price. Demand for rare traits is subjective and community-driven: some collections see linear price-to-rarity relationships, while others show rarity-to-price disconnects where medium-rarity NFTs trade at premiums over higher-rarity pieces due to aesthetic preference or community meme status.", "The most reliable pricing signal is recent comparable sales — NFTs with similar trait combinations that sold within the past 7–30 days. In fast-moving collections, a sale from 60 days ago may reflect a completely different market environment than today. When interpreting rarity scores, also consider the specific traits that are rare: background color rarity in a collection may command minimal premium while rare 'special item' traits command 10x–100x floor price premiums. Not all rare traits are equally desirable."],
      scenarios: ["A collection of 10,000 NFTs. Your NFT has: Rare Background (1% of collection), Uncommon Hat (8%), Common Shirt (40%), Unique Eyes (0.1%). Rarity score calculation: (1/0.01) + (1/0.08) + (1/0.40) + (1/0.001) = 100 + 12.5 + 2.5 + 1000 = 1,115 total rarity score. The Unique Eyes trait alone contributes 90% of the rarity score. If the collection floor is 0.5 ETH, this NFT's rarity premium should theoretically push it to 5x–20x floor ($2.5–10 ETH) — but only if the community values Eyes traits. Check recent sales of other Unique Eyes NFTs to validate the premium.", "A blue-chip collection's floor is 20 ETH. A 'God Tier' rarity (top 0.1%) NFT with a 5,000 rarity score typically trades at 4x–8x floor ($80–160 ETH). Mid-range rarity (top 5–10%) with a 500 rarity score may trade at 1.5x–2x floor ($30–40 ETH). A below-floor-rarity NFT with common traits might trade 20%–30% below floor — unless specific aesthetic traits make it preferred despite low statistical rarity. The market's subjective aesthetic judgment frequently overrides pure rarity math."],
      checklist: ["Before buying any NFT based on rarity, verify three data points: (1) the collection's rarity ranking from at least two independent sources (Rarity.tools and Rarity Sniper may differ), (2) recent sales data for the top 10 NFTs in similar rarity tiers within the collection, and (3) the floor price trend over the past 30 days. Divergence between rarity score and recent sales price reveals which trait categories the community actually values.", "For NFT investments above $5,000, perform provenance research: check ownership history on Etherscan, verify the NFT was minted legitimately (not duplicated or from a fraudulent contract), confirm the collection has ongoing secondary market trading activity (not abandoned), and check whether any high-profile holders or influencers own NFTs in the collection (social signal of quality)."],
      mistakes: ["Treating rarity scores as price targets. A rarity score is a statistical measure, not a price prediction — collections routinely show high-rarity NFTs selling below lower-rarity ones because market participants prefer specific aesthetic combinations over mathematical rareness. The most profitable NFT investments often involve identifying aesthetically desired traits before the broader market recognizes their value, not buying the highest rarity score.", "Ignoring collection-level fundamentals when evaluating individual NFT rarity. An extremely rare NFT in a dying collection may be worth less than a common NFT in a thriving ecosystem. Collection health indicators: daily secondary trading volume, number of unique holders, developer activity, community engagement on Discord/Twitter, and roadmap delivery track record. Individual rarity is meaningless if the collection itself loses market interest."],
      benchmarks: ["Historical NFT rarity premiums across market cycles: during bull markets (2021), top 1% rarity NFTs in blue-chip collections commanded 10x–50x floor price premiums. During bear markets (2022–2023), the same rarity tier compressed to 3x–8x floor. Market conditions affect rarity premiums more than individual trait combinations — the overall market environment is the dominant factor in realized rarity premium levels.", "Liquidity analysis for NFT investments: top-tier collections (BAYC, CryptoPunks) have 50+ sales per day with tight bid-ask spreads of 5%–10%. Mid-tier collections average 5–20 sales per day with 20%–40% bid-ask spreads. Low-tier collections may see 1–2 sales per week — essentially illiquid. Factor liquidity discount into valuations: a 'fair value' of 10 ETH in an illiquid collection may only realize 6–7 ETH in an actual sale due to limited buyer competition."],
      execution: ["Buy NFTs in the 'sweet spot' rarity zone — top 2%–10% rarity rather than top 0.1%–1%. This zone typically offers better liquidity (more potential buyers at that price range), narrower bid-ask spreads, and lower idiosyncratic risk from trait preference shifts. Ultra-rare NFTs (top 0.5%) command high prices but have very few potential buyers, making exits challenging. The sweet spot maximizes the ratio of rarity premium to liquidity cost.", "Time NFT purchases around collection milestones that predictably move floor prices: new collection announcements, artist collaborations, exchange listings, metaverse integrations, and community events. These catalysts create temporary buying pressure that raises floors — buying 2–4 weeks before known catalysts and selling during or immediately after the announcement often produces above-average returns regardless of individual NFT rarity."],
      hygiene: ["Track NFT portfolio value using a reliable aggregator that updates floor prices in near-real-time. Portfolio value in NFTs requires floor price × quantity for common items and individual appraisal for rare pieces. Review portfolio valuations monthly and compare to alternative investment performance. If your NFT portfolio lags both crypto index performance and stablecoin yields for 6+ months, reassess the allocation.", "Set a maximum time horizon for each NFT investment (6 months, 12 months, 24 months). If the NFT hasn't appreciated to your target within that horizon, evaluate whether the thesis has changed or execution is required at market. Perpetually 'holding for the right moment' ties up capital indefinitely — establishing exit timelines prevents sunk-cost-driven holding of illiquid positions that no longer align with current market conditions."],
      validation: ["Verify NFT rarity calculations by checking multiple independent rarity databases. Different platforms use different formulas (trait normalization, statistical rareness vs. information rareness) that produce different rankings for the same NFTs. If an NFT's ranking differs dramatically across platforms, understand which formula better captures what the community actually values — the 'correct' rarity is the one the market believes, not a specific mathematical formula.", "Confirm your NFT's floor price benchmark using actual recent sales, not just listed ask prices. An NFT collection might have a listed floor of 1 ETH (lowest ask price) but actual last sales at 0.6 ETH — the listed floor is aspirational, not realized. Use sales data from OpenSea, Blur, or LooksRare to identify what buyers have actually paid, which is the true market-clearing price."]
    },
    es: { interpret: ["El análisis de rareza y precio de NFT requiere combinar puntuaciones de rareza estadística con factores de sentimiento de mercado.", "La señal de precios más confiable son las ventas comparables recientes."], scenarios: ["Una colección de 10.000 NFTs. Tu NFT tiene: Fondo Raro (1%), Sombrero Poco Común (8%), Camisa Común (40%), Ojos Únicos (0,1%).", "El suelo de una colección blue-chip es 20 ETH. Un NFT 'God Tier' (top 0,1%) con puntuación de rareza de 5,000 típicamente cotiza a 4x–8x suelo."], checklist: ["Antes de comprar cualquier NFT basado en rareza, verifica tres puntos de datos.", "Para inversiones en NFT superiores a $5,000, realiza investigación de procedencia."], mistakes: ["Tratar las puntuaciones de rareza como objetivos de precio.", "Ignorar los fundamentos a nivel de colección al evaluar la rareza de NFT individuales."], benchmarks: ["Primas históricas de rareza de NFT a través de ciclos de mercado.", "Análisis de liquidez para inversiones en NFT."], execution: ["Compra NFTs en la zona de rareza 'óptima' — rareza top 2%–10% en lugar de top 0,1%–1%.", "Sincroniza las compras de NFT alrededor de hitos de colección que predeciblemente mueven los precios del suelo."], hygiene: ["Rastrea el valor del portafolio de NFT usando un agregador confiable que actualiza los precios del suelo en tiempo casi real.", "Establece un horizonte de tiempo máximo para cada inversión en NFT."], validation: ["Verifica los cálculos de rareza de NFT consultando múltiples bases de datos de rareza independientes.", "Confirma tu punto de referencia de precio de suelo de NFT usando ventas reales recientes, no solo los precios de oferta listados."] },
    pt: { interpret: ["A análise de raridade e preço de NFT requer combinar pontuações de raridade estatística com fatores de sentimento de mercado.", "O sinal de preço mais confiável são as vendas comparáveis recentes."], scenarios: ["Uma coleção de 10.000 NFTs. Seu NFT tem: Fundo Raro (1%), Chapéu Incomum (8%), Camisa Comum (40%), Olhos Únicos (0,1%).", "O piso de uma coleção blue-chip é de 20 ETH. Um NFT 'God Tier' (top 0,1%) com pontuação de raridade de 5.000 tipicamente negocia a 4x–8x piso."], checklist: ["Antes de comprar qualquer NFT baseado em raridade, verifique três pontos de dados.", "Para investimentos em NFT acima de $5.000, realize pesquisa de procedência."], mistakes: ["Tratar pontuações de raridade como metas de preço.", "Ignorar fundamentos ao nível da coleção ao avaliar a raridade de NFTs individuais."], benchmarks: ["Prêmios históricos de raridade de NFT através de ciclos de mercado.", "Análise de liquidez para investimentos em NFT."], execution: ["Compre NFTs na zona de raridade 'ideal' — raridade top 2%–10% em vez de top 0,1%–1%.", "Sincronize as compras de NFT em torno de marcos de coleção que previsivelmente movem os preços de piso."], hygiene: ["Rastreie o valor do portfólio de NFT usando um agregador confiável que atualiza os preços de piso em quase tempo real.", "Defina um horizonte de tempo máximo para cada investimento em NFT."], validation: ["Verifique os cálculos de raridade de NFT consultando múltiplos bancos de dados de raridade independentes.", "Confirme seu benchmark de preço de piso de NFT usando vendas reais recentes, não apenas preços de lista."] },
    tr: { interpret: ["NFT nadirlık ve fiyat analizi, tamamen matematiksel modellerin çoğu zaman kaçırdığı piyasa duyarlılığı faktörleriyle istatistiksel nadirlık puanlarını birleştirmeyi gerektirir.", "En güvenilir fiyatlandırma sinyali, son karşılaştırılabilir satışlardır."], scenarios: ["10.000 NFT'lik bir koleksiyon. NFT'niz şunlara sahip: Nadir Arka Plan (%1), Sıradan Dışı Şapka (%8), Sıradan Gömlek (%40), Benzersiz Gözler (%0,1).", "Mavi çipli bir koleksiyonun tabanı 20 ETH. 5.000 nadirlık puanına sahip 'God Tier' nadirlığındaki (top %0,1) NFT tipik olarak tabandan 4x–8x fiyata işlem görüyor."], checklist: ["Nadirlığa dayalı herhangi bir NFT satın almadan önce üç veri noktasını doğrulayın.", "5.000 doların üzerindeki NFT yatırımları için köken araştırması yapın."], mistakes: ["Nadirlık puanlarını fiyat hedefleri olarak ele almak.", "Bireysel NFT nadirlığını değerlendirirken koleksiyon düzeyindeki temel verileri görmezden gelmek."], benchmarks: ["Piyasa döngüleri boyunca tarihsel NFT nadirlık primleri.", "NFT yatırımları için likidite analizi."], execution: ["NFT'leri 'tatlı nokta' nadirlık bölgesinde satın alın — top %0,1–%1 yerine top %2–%10 nadirlık.", "NFT alımlarını öngörülebilir şekilde taban fiyatlarını hareket ettiren koleksiyon kilometre taşları etrafında zamanlayın."], hygiene: ["NFT portföy değerini, taban fiyatlarını neredeyse gerçek zamanlı olarak güncelleyen güvenilir bir toplayıcı kullanarak takip edin.", "Her NFT yatırımı için maksimum bir zaman ufku belirleyin."], validation: ["Birden fazla bağımsız nadirlık veritabanını kontrol ederek NFT nadirlık hesaplamalarını doğrulayın.", "NFT taban fiyatı kıyaslamanızı yalnızca listelenen talep fiyatlarına değil, gerçek son satışları kullanarak onaylayın."] },
    hi: { interpret: ["NFT दुर्लभता और मूल्य विश्लेषण में सांख्यिकीय दुर्लभता स्कोर को बाजार भावना कारकों के साथ संयोजित करने की आवश्यकता होती है जिन्हें विशुद्ध गणितीय मॉडल अक्सर चूक जाते हैं।", "सबसे विश्वसनीय मूल्य निर्धारण संकेत हालिया तुलनीय बिक्री है।"], scenarios: ["10,000 NFT का एक संग्रह। आपके NFT में: दुर्लभ पृष्ठभूमि (1%), असामान्य टोपी (8%), सामान्य शर्ट (40%), अद्वितीय आंखें (0.1%)।", "एक ब्लू-चिप संग्रह का फ्लोर 20 ETH है। 5,000 दुर्लभता स्कोर वाला 'God Tier' (शीर्ष 0.1%) NFT आमतौर पर फ्लोर पर 4x–8x पर ट्रेड करता है।"], checklist: ["दुर्लभता के आधार पर कोई भी NFT खरीदने से पहले, तीन डेटा बिंदु सत्यापित करें।", "$5,000 से अधिक NFT निवेश के लिए, उत्पत्ति अनुसंधान करें।"], mistakes: ["दुर्लभता स्कोर को मूल्य लक्ष्य के रूप में मानना।", "व्यक्तिगत NFT दुर्लभता का मूल्यांकन करते समय संग्रह-स्तर की मूल बातों को नजरअंदाज करना।"], benchmarks: ["बाजार चक्रों में ऐतिहासिक NFT दुर्लभता प्रीमियम।", "NFT निवेश के लिए तरलता विश्लेषण।"], execution: ["'स्वीट स्पॉट' दुर्लभता ज़ोन में NFT खरीदें — शीर्ष 0.1%–1% के बजाय शीर्ष 2%–10% दुर्लभता।", "NFT खरीद को संग्रह मील के पत्थर के आसपास समय दें जो फ्लोर कीमतों को पूर्वानुमानित रूप से बढ़ाते हैं।"], hygiene: ["NFT पोर्टफोलियो मूल्य को एक विश्वसनीय एग्रीगेटर का उपयोग करके ट्रैक करें जो लगभग रीयल-टाइम में फ्लोर कीमतों को अपडेट करता है।", "प्रत्येक NFT निवेश के लिए अधिकतम समय क्षितिज निर्धारित करें।"], validation: ["कई स्वतंत्र दुर्लभता डेटाबेस की जांच करके NFT दुर्लभता गणनाओं को सत्यापित करें।", "केवल सूचीबद्ध आस्क कीमतों पर नहीं, बल्कि वास्तविक हालिया बिक्री का उपयोग करके अपने NFT फ्लोर मूल्य बेंचमार्क की पुष्टि करें।"] },
    ru: { interpret: ["Анализ редкости и цены NFT требует совмещения статистических показателей редкости с факторами рыночных настроений, которые чисто математические модели часто упускают.", "Наиболее надёжный ценовой сигнал — недавние сопоставимые продажи."], scenarios: ["Коллекция из 10 000 NFT. Ваш NFT имеет: Редкий Фон (1%), Необычная Шляпа (8%), Обычная Рубашка (40%), Уникальные Глаза (0,1%).", "Флор голубой фишки — 20 ETH. NFT «God Tier» (топ 0,1%) с рейтингом редкости 5 000 обычно торгуется по 4x–8x флора."], checklist: ["Перед покупкой NFT на основе редкости проверьте три точки данных.", "Для инвестиций в NFT свыше $5 000 проведите исследование провенанса."], mistakes: ["Рассмотрение показателей редкости как ценовых ориентиров.", "Игнорирование фундаментальных показателей коллекции при оценке редкости отдельного NFT."], benchmarks: ["Исторические премии за редкость NFT в разных рыночных циклах.", "Анализ ликвидности для инвестиций в NFT."], execution: ["Покупайте NFT в «золотой середине» редкости — топ 2–10%, а не топ 0,1–1%.", "Синхронизируйте покупки NFT с вехами коллекции, предсказуемо повышающими флор."], hygiene: ["Отслеживайте стоимость портфеля NFT с помощью надёжного агрегатора, обновляющего цены флора в режиме близкого к реальному времени.", "Устанавливайте максимальный горизонт для каждой инвестиции в NFT."], validation: ["Проверяйте расчёты редкости NFT, сверяясь с несколькими независимыми базами данных редкости.", "Подтверждайте ориентир по цене флора NFT, используя фактические недавние продажи, а не только котировки листингов."] }
  },
  'leverage-calculator': {
    en: {
      interpret: ["Leverage calculations reveal the geometric relationship between borrowed capital, potential gains, and catastrophic loss scenarios. When you apply 5x leverage, both gains and losses are multiplied by 5 — and critically, losses are limited by your margin deposit while gains are theoretically unlimited. The asymmetry matters: a 20% adverse move eliminates 100% of your margin at 5x leverage, but a 20% favorable move only doubles it (100% gain). This asymmetry means leverage amplifies the psychological difficulty of trading — small adverse moves feel large, creating pressure to close prematurely or add margin irrationally.", "Understanding effective leverage requires looking at the full position size relative to total portfolio value, not just the exchange-stated leverage ratio. A trader with $100,000 portfolio who opens a $50,000 leveraged position at 5x ($250,000 notional) has effective portfolio leverage of 2.5x — meaningfully different from a trader who opens the same 5x position with $100,000 total margin ($500,000 notional), who has effective portfolio leverage of 5x. Always calculate total portfolio leverage exposure, not just position-level leverage."],
      scenarios: ["$10,000 margin, 10x leverage: $100,000 notional BTC position. BTC rises 10%: gain = $10,000 (100% return on margin). BTC falls 10%: loss = $10,000 (100% of margin = liquidation). BTC falls 9%: loss = $9,000, remaining margin = $1,000 (90% loss on margin). The liquidation threshold is asymmetric: a 10% favorable move returns 100%, while a 9.5% adverse move creates 95% loss. Leverage creates a deeply asymmetric risk profile that favors the house (exchange) over time due to funding costs and bid-ask spreads.", "Comparing leverage scenarios for the same capital: $5,000 margin. Option A: 2x leverage ($10,000 notional). Liquidation at -50% move. Option B: 5x leverage ($25,000 notional). Liquidation at -20% move. Option C: 10x leverage ($50,000 notional). Liquidation at -10% move. For BTC with 5% daily volatility, Option A might need multiple bad days to liquidate, Option B could liquidate in 4 bad days, Option C could liquidate in 2 bad days. The choice is essentially about how many adverse daily moves you can absorb before forced exit."],
      checklist: ["Calculate effective total portfolio leverage before adding any new leveraged position: (total notional value of all positions) / (total portfolio value). Keep this ratio below 3x for aggressive risk tolerance, below 2x for moderate, below 1x for conservative. Portfolio-level leverage tracking prevents the mistake of individually acceptable positions combining into dangerously leveraged total exposure.", "Stress-test leverage positions against scenario analysis: what happens if the asset falls 30% in 24 hours (flash crash scenario)? What if it falls 50% over a week? Map these scenarios to your liquidation price and remaining margin to understand your true worst-case exposure. If a 30% drop would liquidate your position, verify that historical data shows 30% drops are rare, not routine."],
      mistakes: ["Treating leverage as a tool to make large positions affordable rather than as amplification of risk. The correct use of leverage is to maintain a smaller position that still provides meaningful dollar exposure while keeping absolute dollar risk within your position sizing rules. Using leverage to make a position 'big enough to matter' without scaling down the underlying size violates position sizing discipline.", "Ignoring the cost of leverage over time. Leveraged perpetual futures positions pay funding rates that can amount to 3%–30%+ annually. A position held for 6 months at 0.05% daily funding costs 9% of notional — reducing your effective return by the equivalent of 9 percentage points. For leveraged positions held long-term, funding costs can consume most or all of the theoretical alpha, turning a profitable directional view into a net loss."],
      benchmarks: ["Optimal leverage ratios by trading style: scalpers (seconds to minutes) can use 5x–20x with tight stops because positions are held briefly. Day traders (hours) should cap at 3x–5x with stops within normal daily range. Swing traders (days to weeks) should use 1x–2x maximum. Position traders (weeks to months) should rarely use leverage above 1x (spot). The longer the intended holding period, the lower the optimal leverage due to cumulative funding costs and time for adverse scenarios to materialize.", "Leverage and drawdown math: a 10x leveraged position that drops 10% requires the underlying to recover 11.1% to return to break-even. A 5x leveraged position that drops 15% requires 17.6% recovery. The mathematics of losses are not symmetric with gains — percentage losses always require larger percentage gains to recover because the denominator (remaining capital) decreases with each loss. This mathematical reality means leverage combined with losses creates progressively harder recovery requirements."],
      execution: ["Scale into leveraged positions rather than entering full size immediately. Enter at 25%–33% of intended position at first signal, add 25% after confirmation, and add final portion only after the position shows profit. This scaling approach reduces average entry leverage impact and allows you to verify that the trade is working before committing maximum capital — particularly valuable for high-leverage positions where small adverse moves are costly.", "Set maximum leverage limits as hard rules that cannot be overridden by conviction or opportunity. If your rule is 'maximum 5x leverage on any single position,' maintain that limit even when you're confident about a trade's direction. Conviction-based leverage increases are the most common cause of account-destroying events — the times traders are most confident often coincide with peak market speculation rather than high-quality setups."],
      hygiene: ["Monitor effective portfolio leverage daily and reduce when it exceeds your target maximum. If multiple profitable positions have grown, the effective notional exposure relative to account value may have increased significantly beyond your original leverage targets. Periodically reduce position sizes to bring portfolio leverage back to target — treating leverage management as an ongoing portfolio maintenance task rather than a one-time decision.", "Track your leverage history: what average leverage did you use over the past 30/90/180 days? What was your average return and maximum drawdown during each leverage tier? This historical analysis reveals whether higher leverage has actually improved your returns or simply increased volatility without proportional return improvement. Many traders discover that reducing leverage from their habitual level significantly improves risk-adjusted returns."],
      validation: ["Verify leverage calculations by cross-checking the exchange's position notional value against your manual calculation (margin × leverage ratio). If these differ, identify whether the exchange is using a different formula (initial margin vs. maintenance margin) or factoring in unrealized P&L into available margin. Understanding your exchange's exact margin calculation methodology is prerequisite to accurate leverage monitoring.", "Test leverage position sizing by opening a small test position and verifying that the exchange's calculated liquidation price matches your manual calculation. If they differ by more than 1%, investigate the source: funding rates already accrued, different base price used, or maintenance margin requirements differing from initial margin. Accurate liquidation price knowledge is essential for managing leveraged positions safely."]
    },
    es: { interpret: ["Los cálculos de apalancamiento revelan la relación geométrica entre el capital prestado, las ganancias potenciales y los escenarios de pérdidas catastróficas.", "Comprender el apalancamiento efectivo requiere mirar el tamaño completo de la posición en relación con el valor total de la cartera."], scenarios: ["$10,000 de margen, apalancamiento 10x: posición nocional de BTC de $100,000.", "Comparando escenarios de apalancamiento para el mismo capital: $5,000 de margen."], checklist: ["Calcula el apalancamiento total efectivo de la cartera antes de agregar cualquier nueva posición apalancada.", "Realiza pruebas de estrés en las posiciones apalancadas frente al análisis de escenarios."], mistakes: ["Tratar el apalancamiento como una herramienta para hacer grandes posiciones asequibles en lugar de como amplificación del riesgo.", "Ignorar el costo del apalancamiento a lo largo del tiempo."], benchmarks: ["Ratios de apalancamiento óptimos según el estilo de trading.", "Matemáticas de apalancamiento y drawdown."], execution: ["Escala hacia posiciones apalancadas en lugar de ingresar al tamaño completo de inmediato.", "Establece límites de apalancamiento máximo como reglas estrictas que no pueden ser anuladas por la convicción u oportunidad."], hygiene: ["Monitorea el apalancamiento efectivo de la cartera diariamente y redúcelo cuando supere tu máximo objetivo.", "Registra tu historial de apalancamiento."], validation: ["Verifica los cálculos de apalancamiento cruzando el valor nocional de la posición del exchange con tu cálculo manual.", "Prueba el dimensionamiento de posición con apalancamiento abriendo una pequeña posición de prueba."] },
    pt: { interpret: ["Os cálculos de alavancagem revelam a relação geométrica entre capital emprestado, ganhos potenciais e cenários de perda catastrófica.", "Entender a alavancagem efetiva requer olhar para o tamanho total da posição em relação ao valor total do portfólio."], scenarios: ["$10.000 de margem, 10x alavancagem: posição nocional de BTC de $100.000.", "Comparando cenários de alavancagem para o mesmo capital: $5.000 de margem."], checklist: ["Calcule a alavancagem total efetiva do portfólio antes de adicionar qualquer nova posição alavancada.", "Teste de estresse as posições alavancadas contra análise de cenário."], mistakes: ["Tratar a alavancagem como uma ferramenta para tornar grandes posições acessíveis em vez de amplificação de risco.", "Ignorar o custo da alavancagem ao longo do tempo."], benchmarks: ["Razões de alavancagem ótimas por estilo de trading.", "Matemática de alavancagem e drawdown."], execution: ["Escale para posições alavancadas em vez de entrar com o tamanho total imediatamente.", "Defina limites máximos de alavancagem como regras rígidas que não podem ser substituídas por convicção ou oportunidade."], hygiene: ["Monitore a alavancagem efetiva do portfólio diariamente e reduza quando exceder seu máximo alvo.", "Acompanhe seu histórico de alavancagem."], validation: ["Verifique os cálculos de alavancagem verificando o valor nocional da posição da exchange contra seu cálculo manual.", "Teste o dimensionamento de posição com alavancagem abrindo uma pequena posição de teste."] },
    tr: { interpret: ["Kaldıraç hesaplamaları, borçlanılan sermaye, potansiyel kazançlar ve felaket kayıp senaryoları arasındaki geometrik ilişkiyi ortaya koyar.", "Etkin kaldıracı anlamak, tam pozisyon büyüklüğüne toplam portföy değerine oranla bakmayı gerektirir."], scenarios: ["10.000 dolar marjin, 10x kaldıraç: 100.000 dolarlık BTC nosyonel pozisyonu.", "Aynı sermaye için kaldıraç senaryolarını karşılaştırmak: 5.000 dolar marjin."], checklist: ["Herhangi bir yeni kaldıraçlı pozisyon eklemeden önce efektif toplam portföy kaldıracını hesaplayın.", "Kaldıraçlı pozisyonları senaryo analizine karşı stres testi yapın."], mistakes: ["Kaldıracı büyük pozisyonları uygun fiyatlı yapmak için bir araç olarak değil, riskin amplifikasyonu olarak ele almak.", "Kaldıraç maliyetini zaman içinde görmezden gelmek."], benchmarks: ["İşlem stiline göre optimal kaldıraç oranları.", "Kaldıraç ve drawdown matematiği."], execution: ["Kaldıraçlı pozisyonlara tam boyutta girmek yerine ölçeklendirerek girin.", "Maksimum kaldıraç sınırlarını, inanç veya fırsatla geçersiz kılınamayacak katı kurallar olarak belirleyin."], hygiene: ["Efektif portföy kaldıracını günlük izleyin ve hedef maksimumunuzu aştığında azaltın.", "Kaldıraç geçmişinizi takip edin."], validation: ["Exchange'in pozisyon nosyonel değerini manuel hesaplamanızla çapraz kontrol ederek kaldıraç hesaplamalarını doğrulayın.", "Küçük bir test pozisyonu açarak kaldıraçlı pozisyon boyutlandırmasını test edin."] },
    hi: { interpret: ["लीवरेज गणनाएं उधार ली गई पूंजी, संभावित लाभ और विनाशकारी हानि परिदृश्यों के बीच ज्यामितीय संबंध को प्रकट करती हैं।", "प्रभावी लीवरेज को समझने के लिए कुल पोर्टफोलियो मूल्य के सापेक्ष पूर्ण पोजीशन आकार को देखना आवश्यक है।"], scenarios: ["$10,000 मार्जिन, 10x लीवरेज: $100,000 नॉशनल BTC पोजीशन।", "एक ही पूंजी के लिए लीवरेज परिदृश्यों की तुलना करना: $5,000 मार्जिन।"], checklist: ["कोई भी नई लीवरेज्ड पोजीशन जोड़ने से पहले प्रभावी कुल पोर्टफोलियो लीवरेज की गणना करें।", "परिदृश्य विश्लेषण के खिलाफ लीवरेज पोजीशन का तनाव-परीक्षण करें।"], mistakes: ["लीवरेज को जोखिम के आवर्धन के बजाय बड़ी पोजीशन को किफायती बनाने के उपकरण के रूप में मानना।", "समय के साथ लीवरेज की लागत को नजरअंदाज करना।"], benchmarks: ["ट्रेडिंग शैली के अनुसार इष्टतम लीवरेज अनुपात।", "लीवरेज और ड्रॉडाउन गणित।"], execution: ["तुरंत पूरे आकार में प्रवेश करने के बजाय लीवरेज्ड पोजीशन में स्केल करें।", "अधिकतम लीवरेज सीमाओं को कठोर नियमों के रूप में सेट करें जो दृढ़ विश्वास या अवसर द्वारा ओवरराइड नहीं की जा सकती।"], hygiene: ["दैनिक प्रभावी पोर्टफोलियो लीवरेज की निगरानी करें और लक्ष्य अधिकतम से अधिक होने पर घटाएं।", "अपने लीवरेज इतिहास को ट्रैक करें।"], validation: ["एक्सचेंज के पोजीशन नॉशनल मूल्य को अपनी मैनुअल गणना के साथ क्रॉस-चेक करके लीवरेज गणनाओं को सत्यापित करें।", "एक छोटी परीक्षण पोजीशन खोलकर लीवरेज पोजीशन साइजिंग का परीक्षण करें।"] },
    ru: { interpret: ["Расчёты кредитного плеча раскрывают геометрическое соотношение между заёмным капиталом, потенциальными прибылями и катастрофическими убытками.", "Понимание эффективного кредитного плеча требует взгляда на полный размер позиции относительно общей стоимости портфеля."], scenarios: ["Маржа $10 000, плечо 10x: номинальная позиция BTC на $100 000.", "Сравнение сценариев кредитного плеча для одного капитала: маржа $5 000."], checklist: ["Рассчитывайте общее эффективное кредитное плечо портфеля перед добавлением любой новой позиции с плечом.", "Проводите стресс-тестирование позиций с плечом по сценарному анализу."], mistakes: ["Использование кредитного плеча как инструмента для увеличения доступности крупных позиций, а не как усилителя риска.", "Игнорирование стоимости плеча во времени."], benchmarks: ["Оптимальные коэффициенты кредитного плеча по стилю торговли.", "Математика кредитного плеча и просадок."], execution: ["Масштабируйте вход в позиции с плечом вместо полного входа сразу.", "Устанавливайте лимиты максимального кредитного плеча как жёсткие правила, которые нельзя отменить по убеждению или по случаю."], hygiene: ["Ежедневно отслеживайте эффективное кредитное плечо портфеля и снижайте его при превышении целевого максимума.", "Ведите историю использования кредитного плеча."], validation: ["Проверяйте расчёты плеча, сверяя номинальную стоимость позиции на бирже с собственным расчётом.", "Тестируйте размер позиции с плечом, открывая небольшую тестовую позицию."] }
  },
  'inflation-hedge': {
    en: {
      interpret: ["Inflation hedge calculations measure how effectively a crypto asset protects purchasing power against currency debasement — the most critical question being: does this asset's return exceed the inflation rate by enough margin to justify its volatility risk? An asset that returns 8% annually while inflation runs at 7% provides only 1% real return — barely outpacing inflation and insufficient for the risk taken. Bitcoin, designed with a fixed supply cap of 21 million coins, is theoretically the ultimate inflation hedge: unlike fiat currencies, no authority can inflate its supply. But the theoretical inflation hedge property is only valuable in practice if the asset's price appreciates faster than inflation over your relevant investment horizon.", "The practical inflation hedge analysis requires distinguishing between different types of inflation: monetary inflation (expansion of money supply), asset price inflation, and CPI-measured consumer price inflation. Bitcoin has historically far outperformed all three measures over 4-year periods — but has dramatically underperformed in specific 1-2 year windows (2018, 2022) that coincided with risk-off environments despite high monetary inflation. The inflation hedge property is statistical over long time periods, not reliable quarter-to-quarter."],
      scenarios: ["An investor allocates 10% of savings to Bitcoin as an inflation hedge. Scenario A (inflationary decade): CPI averages 8% annually. Gold returns 6% annually (below inflation). Bitcoin returns 40% annually on average. After 10 years: $100,000 Bitcoin allocation grows to $2.89M. CPI-adjusted purchasing power required: $215,892. Bitcoin's real purchasing power: $2.89M / $2.16 = $1.34M in today's dollars — a 1,340% real return, far exceeding inflation hedge objectives.", "An investor in a hyperinflationary economy (Venezuela, Argentina model): local currency loses 100% of value annually. Converting $1,000 to Bitcoin: even if Bitcoin 'merely' maintains USD price, the investor preserves purchasing power completely. If Bitcoin also appreciates in USD terms, they gain additional real return. The inflation hedge value in hyperinflationary contexts is binary — holding local currency guarantees loss, while Bitcoin provides at minimum USD-purchasing-power preservation even without price appreciation."],
      checklist: ["Calculate your personal inflation rate rather than using headline CPI. If your spending is concentrated in housing, healthcare, and education (which have inflated faster than CPI), your actual purchasing power erosion may be 3%–5% higher than the reported CPI rate. Your crypto inflation hedge target return should exceed your personal inflation rate, not just the official number.", "Assess the correlation between your crypto holdings and traditional inflation hedges (gold, real estate, inflation-protected bonds). If Bitcoin is your primary inflation hedge, understand that its inflation hedge properties are strongest over 4-year periods but can disconnect from inflation in shorter windows. Complementing Bitcoin with gold or TIPS (Treasury Inflation-Protected Securities) provides more consistent shorter-term inflation protection."],
      mistakes: ["Using short-term price performance as validation of inflation hedge effectiveness. Bitcoin's price falling 60% during a period of high inflation doesn't mean it's a 'failed' inflation hedge — it means the market's risk-off behavior temporarily dominated the inflation hedge thesis. The inflation hedge property is statistical over decades, not deterministic over quarters. Short-term underperformance during inflationary periods doesn't invalidate the long-term hedge hypothesis.", "Concentrating too much in a single crypto asset for inflation hedging purposes. While Bitcoin has the strongest inflation hedge narrative (fixed supply, long track record), concentrating 100% of inflation hedge allocation into Bitcoin creates single-asset risk. Diversifying across Bitcoin, Ethereum (deflationary post-merge), and stablecoin yields (providing USDC returns above inflation in some rate environments) creates a more robust inflation protection portfolio."],
      benchmarks: ["Historical Bitcoin vs. inflation performance: since 2013, Bitcoin has outperformed US CPI in 8 of 10 calendar years. The two exceptions (2014, 2018) saw Bitcoin underperform by 60%+ — demonstrating that the inflation hedge property is directionally correct but not perfectly reliable in any single year. On a rolling 4-year basis (one Bitcoin halving cycle), Bitcoin has outperformed inflation in every completed cycle since 2013.", "Stablecoin yield comparison for inflation hedging: during 2022–2023, USDC deposited in Compound or Aave earned 3%–8% APY, roughly matching or slightly exceeding US CPI. For investors who want inflation protection without Bitcoin volatility, stablecoin yield farming provided practical inflation-matching returns during that period — without the 60% drawdown risk of directional crypto exposure."],
      execution: ["Structure your crypto inflation hedge as a 3-bucket approach: (1) Bitcoin core position (long-term store of value, 5–10 year horizon), (2) Ethereum or DeFi yield positions (medium-term, generating yield above inflation), and (3) Stablecoin yield positions (short-term, providing liquid inflation-matching returns). This tiered approach provides inflation protection across different time horizons with appropriately matched risk profiles.", "Rebalance the inflation hedge portfolio annually based on both portfolio performance and the inflation environment. During periods of high inflation with rising interest rates, shift more weight toward the stablecoin yield bucket (benefiting from higher DeFi yields). During low-inflation, high-growth environments, shift more weight toward Bitcoin and Ethereum for maximal real return potential."],
      hygiene: ["Calculate your portfolio's real return quarterly: subtract CPI inflation from nominal crypto returns to track whether you're actually preserving purchasing power or just generating nominal gains that inflation erodes. A portfolio returning 20% nominally during a 20% inflation environment has zero real gain — the nominal return headline is misleading without the inflation adjustment.", "Document your inflation hedge thesis explicitly: what inflation scenario are you hedging against? Mild inflation (3%–5%), significant inflation (5%–15%), or hyperinflation (>20%)? Different scenarios warrant different portfolio structures. Your hedge should be calibrated to the probability-weighted inflation scenario you're most concerned about, not a generic 'crypto as inflation hedge' stance without specificity."],
      validation: ["Test your inflation hedge effectiveness by comparing your portfolio's purchasing power in real terms year-over-year. Define a basket of goods and services that represents your actual consumption (housing, food, healthcare, transportation). Has your portfolio grown enough to buy the same basket each year? This real-world purchasing power test provides clearer validation of hedge effectiveness than abstract return comparisons.", "Backtest your inflation hedge strategy against historical periods of high inflation. How would your current allocation have performed during the 1970s US stagflation? During the 2008–2012 period? (Bitcoin barely existed, but gold and commodities did.) Understanding how similar portfolios performed in past inflationary environments reveals the robustness of your current strategy and identifies gaps where additional hedging may be warranted."]
    },
    es: { interpret: ["Los cálculos de cobertura contra la inflación miden con qué eficacia un activo cripto protege el poder adquisitivo contra la devaluación de la moneda.", "El análisis práctico de cobertura contra la inflación requiere distinguir entre diferentes tipos de inflación."], scenarios: ["Un inversor asigna el 10% de sus ahorros a Bitcoin como cobertura contra la inflación.", "Un inversor en una economía hiperinflacionaria (modelo Venezuela, Argentina)."], checklist: ["Calcula tu tasa de inflación personal en lugar de usar el IPC general.", "Evalúa la correlación entre tus tenencias de cripto y las coberturas tradicionales contra la inflación."], mistakes: ["Usar el rendimiento de precios a corto plazo como validación de la efectividad de la cobertura contra la inflación.", "Concentrar demasiado en un solo activo cripto para propósitos de cobertura contra la inflación."], benchmarks: ["Rendimiento histórico de Bitcoin vs. inflación.", "Comparación de rendimiento de stablecoins para cobertura contra la inflación."], execution: ["Estructura tu cobertura cripto contra la inflación como un enfoque de 3 cubos.", "Reequilibra la cartera de cobertura contra la inflación anualmente."], hygiene: ["Calcula el retorno real de tu cartera trimestralmente.", "Documenta explícitamente tu tesis de cobertura contra la inflación."], validation: ["Prueba la efectividad de tu cobertura contra la inflación comparando el poder adquisitivo real de tu cartera año tras año.", "Realiza backtesting de tu estrategia de cobertura contra la inflación contra períodos históricos de alta inflación."] },
    pt: { interpret: ["Os cálculos de proteção contra a inflação medem com que eficácia um ativo cripto protege o poder de compra contra a desvalorização da moeda.", "A análise prática de proteção contra a inflação requer distinguir entre diferentes tipos de inflação."], scenarios: ["Um investidor aloca 10% de suas economias em Bitcoin como proteção contra a inflação.", "Um investidor em uma economia hiperinflacionária (modelo Venezuela, Argentina)."], checklist: ["Calcule sua taxa de inflação pessoal em vez de usar o CPI geral.", "Avalie a correlação entre suas participações em cripto e proteções tradicionais contra a inflação."], mistakes: ["Usar o desempenho de preços de curto prazo como validação da eficácia da proteção contra a inflação.", "Concentrar muito em um único ativo cripto para fins de proteção contra a inflação."], benchmarks: ["Desempenho histórico do Bitcoin vs. inflação.", "Comparação de rendimento de stablecoin para proteção contra a inflação."], execution: ["Estruture sua proteção cripto contra a inflação como uma abordagem de 3 buckets.", "Rebalanceie o portfólio de proteção contra a inflação anualmente."], hygiene: ["Calcule o retorno real do seu portfólio trimestralmente.", "Documente explicitamente sua tese de proteção contra a inflação."], validation: ["Teste a eficácia da sua proteção contra a inflação comparando o poder de compra real do seu portfólio ano a ano.", "Faça backtest de sua estratégia de proteção contra a inflação contra períodos históricos de alta inflação."] },
    tr: { interpret: ["Enflasyona karşı korunma hesaplamaları, bir kripto varlığın satın alma gücünü para değer kaybına karşı ne kadar etkin biçimde koruduğunu ölçer.", "Pratik enflasyona karşı korunma analizi, farklı enflasyon türleri arasında ayrım yapmayı gerektirir."], scenarios: ["Bir yatırımcı, enflasyona karşı korunma olarak tasarruflarının %10'unu Bitcoin'e tahsis ediyor.", "Hiperenflasyoncu bir ekonomideki (Venezuela, Arjantin modeli) bir yatırımcı."], checklist: ["Manşet TÜFE'yi kullanmak yerine kişisel enflasyon oranınızı hesaplayın.", "Kripto tutumlarınız ile geleneksel enflasyona karşı korumalar arasındaki korelasyonu değerlendirin."], mistakes: ["Kısa vadeli fiyat performansını enflasyona karşı korunma etkinliğinin doğrulaması olarak kullanmak.", "Enflasyona karşı korunma amacıyla tek bir kripto varlığa çok fazla yoğunlaşmak."], benchmarks: ["Bitcoin'in tarihsel enflasyona karşı performansı.", "Enflasyona karşı korunma için stabilcoin getiri karşılaştırması."], execution: ["Kripto enflasyona karşı korunmanızı 3 kovalı bir yaklaşım olarak yapılandırın.", "Enflasyona karşı korunma portföyünü yıllık olarak yeniden dengeleyin."], hygiene: ["Portföyünüzün gerçek getirisini üç ayda bir hesaplayın.", "Enflasyona karşı korunma tezinizi açıkça belgeleyin."], validation: ["Portföyünüzün reel satın alma gücünü yıldan yıla karşılaştırarak enflasyona karşı korunma etkinliğinizi test edin.", "Enflasyona karşı korunma stratejinizi yüksek enflasyonun yaşandığı tarihsel dönemlere karşı geriye dönük test edin."] },
    hi: { interpret: ["मुद्रास्फीति हेज गणनाएं मापती हैं कि एक क्रिप्टो संपत्ति मुद्रा अवमूल्यन के खिलाफ क्रय शक्ति को कितनी प्रभावी ढंग से सुरक्षित करती है।", "व्यावहारिक मुद्रास्फीति हेज विश्लेषण के लिए विभिन्न प्रकार की मुद्रास्फीति के बीच अंतर करना आवश्यक है।"], scenarios: ["एक निवेशक मुद्रास्फीति हेज के रूप में बचत का 10% Bitcoin में आवंटित करता है।", "एक हाइपरइन्फ्लेशनरी अर्थव्यवस्था (वेनेजुएला, अर्जेंटीना मॉडल) में एक निवेशक।"], checklist: ["सामान्य CPI का उपयोग करने के बजाय अपनी व्यक्तिगत मुद्रास्फीति दर की गणना करें।", "अपनी क्रिप्टो होल्डिंग और पारंपरिक मुद्रास्फीति हेज के बीच सहसंबंध का आकलन करें।"], mistakes: ["अल्पकालिक मूल्य प्रदर्शन को मुद्रास्फीति हेज प्रभावशीलता के सत्यापन के रूप में उपयोग करना।", "मुद्रास्फीति हेजिंग उद्देश्यों के लिए एकल क्रिप्टो संपत्ति में बहुत अधिक केंद्रित करना।"], benchmarks: ["Bitcoin बनाम मुद्रास्फीति का ऐतिहासिक प्रदर्शन।", "मुद्रास्फीति हेजिंग के लिए स्टेबलकॉइन यील्ड तुलना।"], execution: ["अपने क्रिप्टो मुद्रास्फीति हेज को 3-बकेट दृष्टिकोण के रूप में संरचित करें।", "मुद्रास्फीति हेज पोर्टफोलियो को वार्षिक रूप से रीबैलेंस करें।"], hygiene: ["अपने पोर्टफोलियो के वास्तविक रिटर्न की त्रैमासिक गणना करें।", "अपनी मुद्रास्फीति हेज थीसिस को स्पष्ट रूप से दस्तावेज़ करें।"], validation: ["वर्ष-दर-वर्ष वास्तविक शर्तों में अपने पोर्टफोलियो की क्रय शक्ति की तुलना करके अपनी मुद्रास्फीति हेज प्रभावशीलता का परीक्षण करें।", "उच्च मुद्रास्फीति के ऐतिहासिक अवधियों के खिलाफ अपनी मुद्रास्फीति हेज रणनीति का बैकटेस्ट करें।"] },
    ru: { interpret: ["Расчёты хеджирования инфляции измеряют, насколько эффективно крипто-актив защищает покупательную способность от обесценивания валюты.", "Практический анализ хеджирования инфляции требует разграничения между различными типами инфляции."], scenarios: ["Инвестор выделяет 10% сбережений в Bitcoin в качестве хеджа от инфляции.", "Инвестор в гиперинфляционной экономике (модель Венесуэлы, Аргентины)."], checklist: ["Рассчитывайте личную инфляцию вместо использования заголовочного ИПЦ.", "Оцените корреляцию между крипто-активами и традиционными инструментами защиты от инфляции."], mistakes: ["Использование краткосрочной ценовой динамики для проверки эффективности хеджирования инфляции.", "Чрезмерная концентрация в одном крипто-активе для защиты от инфляции."], benchmarks: ["Исторические результаты Bitcoin против инфляции.", "Сравнение доходности стейблкоинов для хеджирования инфляции."], execution: ["Структурируйте крипто-хедж инфляции по принципу 3 сегментов.", "Ежегодно ребалансируйте портфель хеджирования инфляции."], hygiene: ["Ежеквартально рассчитывайте реальную доходность портфеля.", "Чётко документируйте тезис о хеджировании инфляции."], validation: ["Тестируйте эффективность хеджирования инфляции, сравнивая реальную покупательную способность портфеля год к году.", "Проводите бэктест стратегии хеджирования инфляции против исторических периодов высокой инфляции."] }
  },
};
