...
export const CALCULATOR_META: Record<Lang, Record<SpecCalculatorSlug, { title: string; description: string }>> = {
  'en': {
    'converter': {
      title: 'Crypto Converter | CryptoCalk — CryptoCalk',
    ...
    'profit-calculator': {
      title: 'Crypto Profit Calculator | CryptoCalk — CryptoCalk',
    ...
    'mining-calculator': {
      title: 'Bitcoin Mining Calculator | CryptoCalk — CryptoCalk',
    ...
    'dca-calculator': {
      title: 'DCA Calculator | CryptoCalk — CryptoCalk',
    ...
    'tax-calculator': {
      title: 'Crypto Tax Calculator | CryptoCalk — CryptoCalk',
    ...
    'what-if': {
      title: 'What If Calculator | CryptoCalk — CryptoCalk',
    ...
    'position-size-calculator': {
      title: 'Position Size Calculator | CryptoCalk — CryptoCalk',
    ...
    'liquidation-calculator': {
      title: 'Liquidation Calculator | CryptoCalk — CryptoCalk',
    ...
    'funding-rate-calculator': {
      title: 'Funding Rate Calculator | CryptoCalk — CryptoCalk',
    ...
    'tp-sl-calculator': {
      title: 'TP / SL Calculator | CryptoCalk — CryptoCalk',
    ...
    'margin-calculator': {
      title: 'Margin Calculator | CryptoCalk — CryptoCalk',
    ...
    'pip-calculator': {
      title: 'Pip / Tick Value Calculator | CryptoCalk — CryptoCalk',
    ...
    'break-even-calculator': {
      title: 'Break-Even Calculator | CryptoCalk — CryptoCalk',
    ...
    'risk-reward-calculator': {
      title: 'Risk / Reward Calculator | CryptoCalk — CryptoCalk',
    ...
    'staking-calculator': {
      title: 'Crypto Staking Calculator | CryptoCalk — CryptoCalk',
    ...
    'impermanent-loss-calculator': {
      title: 'Impermanent Loss Calculator | CryptoCalk — CryptoCalk',
    ...
    'apy-apr-calculator': {
      title: 'APY vs APR Calculator | CryptoCalk — CryptoCalk',
    ...
    'yield-farming-calculator': {
      title: 'Yield Farming Calculator | CryptoCalk — CryptoCalk',
    ...
    'gas-calculator': {
      title: 'Crypto Gas Calculator | CryptoCalk — CryptoCalk',
    ...
    'uniswap-calculator': {
      title: 'Uniswap Fee Calculator | CryptoCalk — CryptoCalk',
    ...
    'bridge-comparator': {
      title: 'Bridge Cost Comparator | CryptoCalk — CryptoCalk',
    ...
    'lending-calculator': {
      title: 'Crypto Lending Calculator | CryptoCalk — CryptoCalk',
    ...
    'gpu-mining-calculator': {
      title: 'GPU Mining Calculator | CryptoCalk — CryptoCalk',
    ...
    'asic-mining-calculator': {
      title: 'ASIC Mining Calculator | CryptoCalk — CryptoCalk',
    ...
    'mining-roi-calculator': {
      title: 'Mining ROI Calculator | CryptoCalk — CryptoCalk',
    ...
    'electricity-cost-calculator': {
      title: 'Mining Electricity Cost Calculator | CryptoCalk — CryptoCalk',
    ...
    'difficulty-calculator': {
      title: 'Mining Difficulty Estimator | CryptoCalk — CryptoCalk',
    ...
    'hashrate-converter': {
      title: 'Hashrate Converter | CryptoCalk — CryptoCalk',
    ...
    'market-cap-calculator': {
      title: 'Market Cap Calculator | CryptoCalk — CryptoCalk',
    ...
    'market-cap-comparator': {
      title: 'Market Cap Comparator | CryptoCalk — CryptoCalk',
    ...
    'roi-calculator': {
      title: 'ROI Calculator | CryptoCalk — CryptoCalk',
    ...
    'reverse-roi': {
      title: 'Reverse ROI Calculator | CryptoCalk — CryptoCalk',
    ...
    'hodl-vs-trade': {
      title: 'HODL vs Trade Calculator | CryptoCalk — CryptoCalk',
    ...
    'rebalancing-calculator': {
      title: 'Portfolio Rebalancing Calculator | CryptoCalk — CryptoCalk',
    ...
    'compound-calculator': {
      title: 'Compound Interest Calculator (Crypto) | CryptoCalk — CryptoCalk',
    ...
    'ico-roi-calculator': {
      title: 'ICO / IDO ROI Calculator | CryptoCalk — CryptoCalk',
    ...
    'airdrop-calculator': {
      title: 'Airdrop Value Calculator | CryptoCalk — CryptoCalk',
    ...
    'satoshi-converter': {
      title: 'Satoshi Converter | CryptoCalk — CryptoCalk',
    ...
    'gwei-converter': {
      title: 'Gwei Converter | CryptoCalk — CryptoCalk',
    ...
    'timestamp-converter': {
      title: 'Unix Timestamp Converter | CryptoCalk — CryptoCalk',
    ...
    'unit-converter': {
      title: 'Crypto Unit Converter | CryptoCalk — CryptoCalk',
    ...
    'exchange-fees': {
      title: 'Exchange Fee Comparator | CryptoCalk — CryptoCalk',
    ...
    'crypto-loan-calculator': {
      title: 'Crypto Loan Calculator | CryptoCalk — CryptoCalk',
    ...
    'vesting-calculator': {
      title: 'Token Vesting Calculator | CryptoCalk — CryptoCalk',
    ...
    'nft-profit-calculator': {
      title: 'NFT Profit Calculator | CryptoCalk — CryptoCalk',
    ...
    'halving-calculator': {
      title: 'Bitcoin Halving Calculator | CryptoCalk — CryptoCalk',
    ...
    'mev-calculator': {
      title: 'MEV Protection Calculator | CryptoCalk — CryptoCalk',
    ...
    'gamefi-calculator': {
      title: 'GameFi ROI Calculator | CryptoCalk — CryptoCalk',
    ...
    'node-calculator': {
      title: 'Validator Node Calculator | CryptoCalk — CryptoCalk',
    ...
    'salary-calculator': {
      title: 'Crypto Salary Calculator | CryptoCalk — CryptoCalk',
    ...
    'inflation-hedge': {
      title: 'Inflation Hedge Calculator | CryptoCalk — CryptoCalk',
  ...
  'es': {
    'converter': {
      title: 'Conversor de Criptomonedas — CryptoCalk',
    ...
    'profit-calculator': {
      title: 'Calculadora de Ganancias Cripto — CryptoCalk',
    ...
    'mining-calculator': {
      title: 'Calculadora de Minería de Bitcoin — CryptoCalk',
    ...
    'dca-calculator': {
      title: 'Calculadora DCA — CryptoCalk',
    ...
    'tax-calculator': {
      title: 'Calculadora de Impuestos Cripto — CryptoCalk',
    ...
    'what-if': {
      title: 'Calculadora Y Si (What If) — CryptoCalk',
    ...
    'position-size-calculator': {
      title: 'Calculadora de Tamaño de Posición — CryptoCalk',
    ...
    'liquidation-calculator': {
      title: 'Calculadora de Liquidación — CryptoCalk',
    ...
    'funding-rate-calculator': {
      title: 'Calculadora de Tasa de Financiación — CryptoCalk',
    ...
    'tp-sl-calculator': {
      title: 'Calculadora TP / SL — CryptoCalk',
    ...
    'margin-calculator': {
      title: 'Calculadora de Margen — CryptoCalk',
    ...
    'pip-calculator': {
      title: 'Calculadora de Valor de Pip — CryptoCalk',
    ...
    'break-even-calculator': {
      title: 'Calculadora de Punto de Equilibrio — CryptoCalk',
    ...
    'risk-reward-calculator': {
      title: 'Calculadora de Riesgo / Beneficio — CryptoCalk',
    ...
    'staking-calculator': {
      title: 'Calculadora de Staking Cripto — CryptoCalk',
    ...
    'impermanent-loss-calculator': {
      title: 'Calculadora de Pérdida Impermanente — CryptoCalk',
    ...
    'apy-apr-calculator': {
      title: 'Calculadora APY vs APR — CryptoCalk',
    ...
    'yield-farming-calculator': {
      title: 'Calculadora de Yield Farming — CryptoCalk',
    ...
    'gas-calculator': {
      title: 'Calculadora de Gas Cripto — CryptoCalk',
    ...
    'uniswap-calculator': {
      title: 'Calculadora de Comisiones Uniswap — CryptoCalk',
    ...
    'bridge-comparator': {
      title: 'Comparador de Costes de Bridge — CryptoCalk',
    ...
    'lending-calculator': {
      title: 'Calculadora de Préstamos Cripto — CryptoCalk',
    ...
    'gpu-mining-calculator': {
      title: 'Calculadora de Minería GPU — CryptoCalk',
    ...
    'asic-mining-calculator': {
      title: 'Calculadora de Minería ASIC — CryptoCalk',
    ...
    'mining-roi-calculator': {
      title: 'Calculadora ROI de Minería — CryptoCalk',
    ...
    'electricity-cost-calculator': {
      title: 'Calculadora de Coste Eléctrico de Minería — CryptoCalk',
    ...
    'difficulty-calculator': {
      title: 'Estimador de Dificultad de Minería — CryptoCalk',
    ...
    'hashrate-converter': {
      title: 'Conversor de Hashrate — CryptoCalk',
    ...
    'market-cap-calculator': {
      title: 'Calculadora de Capitalización de Mercado — CryptoCalk',
    ...
    'market-cap-comparator': {
      title: 'Comparador de Capitalización de Mercado — CryptoCalk',
    ...
    'roi-calculator': {
      title: 'Calculadora de ROI — CryptoCalk',
    ...
    'reverse-roi': {
      title: 'Calculadora de ROI Inverso — CryptoCalk',
    ...
    'hodl-vs-trade': {
      title: 'Calculadora HODL vs Trading — CryptoCalk',
    ...
    'rebalancing-calculator': {
      title: 'Calculadora de Rebalanceo de Cartera — CryptoCalk',
    ...
    'compound-calculator': {
      title: 'Calculadora de Interés Compuesto (Cripto) — CryptoCalk',
    ...
    'ico-roi-calculator': {
      title: 'Calculadora de ROI de ICO / IDO — CryptoCalk',
    ...
    'airdrop-calculator': {
      title: 'Calculadora de Valor de Airdrop — CryptoCalk',
    ...
    'satoshi-converter': {
      title: 'Conversor de Satoshis — CryptoCalk',
    ...
    'gwei-converter': {
      title: 'Conversor de Gwei — CryptoCalk',
    ...
    'timestamp-converter': {
      title: 'Conversor de Marca de Tiempo Unix — CryptoCalk',
    ...
    'unit-converter': {
      title: 'Conversor de Unidades Cripto — CryptoCalk',
    ...
    'exchange-fees': {
      title: 'Comparador de Comisiones de Exchanges — CryptoCalk',
    ...
    'crypto-loan-calculator': {
      title: 'Calculadora de Préstamo Cripto — CryptoCalk',
    ...
    'vesting-calculator': {
      title: 'Calculadora de Vesting de Tokens — CryptoCalk',
    ...
    'nft-profit-calculator': {
      title: 'Calculadora de Ganancias NFT — CryptoCalk',
    ...
    'halving-calculator': {
      title: 'Calculadora de Halving de Bitcoin — CryptoCalk',
    ...
    'mev-calculator': {
      title: 'Calculadora de Protección MEV — CryptoCalk',
    ...
    'gamefi-calculator': {
      title: 'Calculadora ROI de GameFi — CryptoCalk',
    ...
    'node-calculator': {
      title: 'Calculadora de Nodo Validador — CryptoCalk',
    ...
    'salary-calculator': {
      title: 'Calculadora de Salario Cripto — CryptoCalk',
    ...
    'inflation-hedge': {
      title: 'Calculadora de Cobertura de Inflación — CryptoCalk',
  ...
  'pt': {
    'converter': {
      title: 'Conversor de Criptomoedas — CryptoCalk',
    ...
    'profit-calculator': {
      title: 'Calculadora de Lucro Cripto — CryptoCalk',
    ...
    'mining-calculator': {
      title: 'Calculadora de Mineração de Bitcoin — CryptoCalk',
    ...
    'tax-calculator': {
      title: 'Calculadora de Impostos Cripto — CryptoCalk',
    ...
    'what-if': {
      title: 'Calculadora E Se (What If) — CryptoCalk',
    ...
    'position-size-calculator': {
      title: 'Calculadora de Tamanho de Posição — CryptoCalk',
    ...
    'liquidation-calculator': {
      title: 'Calculadora de Liquidação — CryptoCalk',
    ...
    'funding-rate-calculator': {
      title: 'Calculadora de Taxa de Financiamento — CryptoCalk',
    ...
    'margin-calculator': {
      title: 'Calculadora de Margem — CryptoCalk',
    ...
    'break-even-calculator': {
      title: 'Calculadora de Ponto de Equilíbrio — CryptoCalk',
    ...
    'risk-reward-calculator': {
      title: 'Calculadora de Risco / Retorno — CryptoCalk',
    ...
    'impermanent-loss-calculator': {
      title: 'Calculadora de Perda Impermanente — CryptoCalk',
    ...
    'uniswap-calculator': {
      title: 'Calculadora de Taxas Uniswap — CryptoCalk',
    ...
    'bridge-comparator': {
      title: 'Comparador de Custos de Bridge — CryptoCalk',
    ...
    'lending-calculator': {
      title: 'Calculadora de Empréstimos Cripto — CryptoCalk',
    ...
    'gpu-mining-calculator': {
      title: 'Calculadora de Mineração GPU — CryptoCalk',
    ...
    'asic-mining-calculator': {
      title: 'Calculadora de Mineração ASIC — CryptoCalk',
    ...
    'mining-roi-calculator': {
      title: 'Calculadora ROI de Mineração — CryptoCalk',
    ...
    'electricity-cost-calculator': {
      title: 'Calculadora de Custo de Eletricidade para Mineração — CryptoCalk',
    ...
    'difficulty-calculator': {
      title: 'Avaliador de Dificuldade de Mineração — CryptoCalk',
    ...
    'market-cap-calculator': {
      title: 'Calculadora de Capitalização de Mercado — CryptoCalk',
    ...
    'market-cap-comparator': {
      title: 'Comparador de Capitalização de Mercado — CryptoCalk',
    ...
    'reverse-roi': {
      title: 'Calculadora de ROI Reverso — CryptoCalk',
    ...
    'rebalancing-calculator': {
      title: 'Calculadora de Rebalanceamento de Carteira — CryptoCalk',
    ...
    'compound-calculator': {
      title: 'Calculadora de Juros Compostos (Cripto) — CryptoCalk',
    ...
    'satoshi-converter': {
      title: 'Conversor de Satoshi — CryptoCalk',
    ...
    'timestamp-converter': {
      title: 'Conversor de Timestamp Unix — CryptoCalk',
    ...
    'exchange-fees': {
      title: 'Comparador de Taxas de Exchanges — CryptoCalk',
    ...
    'crypto-loan-calculator': {
      title: 'Calculadora de Empréstimo Cripto — CryptoCalk',
    ...
    'nft-profit-calculator': {
      title: 'Calculadora de Lucro NFT — CryptoCalk',
    ...
    'halving-calculator': {
      title: 'Calculadora de Halving do Bitcoin — CryptoCalk',
    ...
    'mev-calculator': {
      title: 'Calculadora de Proteção MEV — CryptoCalk',
    ...
    'gamefi-calculator': {
      title: 'Calculadora de ROI GameFi — CryptoCalk',
    ...
    'node-calculator': {
      title: 'Calculadora de Nó Validador — CryptoCalk',
    ...
    'salary-calculator': {
      title: 'Calculadora de Salário Cripto — CryptoCalk',
    ...
    'inflation-hedge': {
      title: 'Calculadora de Proteção contra Inflação — CryptoCalk',
  ...
  'tr': {
    'converter': {
      title: 'Kripto Para Dönüştürücü — CryptoCalk',
    ...
    'profit-calculator': {
      title: 'Kripto Kar Hesaplayıcı — CryptoCalk',
    ...
    'mining-calculator': {
      title: 'Bitcoin Madencilik Hesaplayıcı — CryptoCalk',
    ...
    'dca-calculator': {
      title: 'DCA Hesaplayıcı — CryptoCalk',
    ...
    'tax-calculator': {
      title: 'Kripto Vergi Hesaplayıcı — CryptoCalk',
    ...
    'what-if': {
      title: 'Ya Öyle Olsaydı Hesaplayıcı — CryptoCalk',
    ...
    'position-size-calculator': {
      title: 'Pozisyon Boyutu Hesaplayıcı — CryptoCalk',
    ...
    'liquidation-calculator': {
      title: 'Likidasyon Hesaplayıcı — CryptoCalk',
    ...
    'funding-rate-calculator': {
      title: 'Fonlama Oranı Hesaplayıcı — CryptoCalk',
    ...
    'tp-sl-calculator': {
      title: 'TP / SL Hesaplayıcı — CryptoCalk',
    ...
    'margin-calculator': {
      title: 'Marjin Hesaplayıcı — CryptoCalk',
    ...
    'pip-calculator': {
      title: 'Pip / Tick Değeri Hesaplayıcı — CryptoCalk',
    ...
    'break-even-calculator': {
      title: 'Başa Baş Hesaplayıcı — CryptoCalk',
    ...
    'risk-reward-calculator': {
      title: 'Risk / Ödül Hesaplayıcı — CryptoCalk',
    ...
    'staking-calculator': {
      title: 'Kripto Staking Hesaplayıcı — CryptoCalk',
    ...
    'impermanent-loss-calculator': {
      title: 'Geçici Kayıp Hesaplayıcı — CryptoCalk',
    ...
    'apy-apr-calculator': {
      title: 'APY ve APR Hesaplayıcı — CryptoCalk',
    ...
    'yield-farming-calculator': {
      title: 'Getiri Çiftçiliği Hesaplayıcı — CryptoCalk',
    ...
    'gas-calculator': {
      title: 'Kripto Gas Hesaplayıcı — CryptoCalk',
    ...
    'uniswap-calculator': {
      title: 'Uniswap Ücret Hesaplayıcı — CryptoCalk',
    ...
    'bridge-comparator': {
      title: 'Köprü Maliyet Karşılaştırıcı — CryptoCalk',
    ...
    'lending-calculator': {
      title: 'Kripto Borç Verme Hesaplayıcı — CryptoCalk',
    ...
    'gpu-mining-calculator': {
      title: 'GPU Madencilik Hesaplayıcı — CryptoCalk',
    ...
    'asic-mining-calculator': {
      title: 'ASIC Madencilik Hesaplayıcı — CryptoCalk',
    ...
    'mining-roi-calculator': {
      title: 'Madencilik ROI Hesaplayıcı — CryptoCalk',
    ...
    'electricity-cost-calculator': {
      title: 'Madencilik Elektrik Maliyeti Hesaplayıcı — CryptoCalk',
    ...
    'difficulty-calculator': {
      title: 'Madencilik Zorluk Tahmincisi — CryptoCalk',
    ...
    'hashrate-converter': {
      title: 'Hashrate Dönüştürücü — CryptoCalk',
    ...
    'market-cap-calculator': {
      title: 'Piyasa Değeri Hesaplayıcı — CryptoCalk',
    ...
    'market-cap-comparator': {
      title: 'Piyasa Değeri Karşılaştırıcı — CryptoCalk',
    ...
    'roi-calculator': {
      title: 'ROI Hesaplayıcı — CryptoCalk',
    ...
    'reverse-roi': {
      title: 'Ters ROI Hesaplayıcı — CryptoCalk',
    ...
    'hodl-vs-trade': {
      title: 'HODL vs Trade Hesaplayıcı — CryptoCalk',
    ...
    'rebalancing-calculator': {
      title: 'Portföy Yeniden Dengeleme Hesaplayıcı — CryptoCalk',
    ...
    'compound-calculator': {
      title: 'Bileşik Faiz Hesaplayıcı (Kripto) — CryptoCalk',
    ...
    'ico-roi-calculator': {
      title: 'ICO / IDO ROI Hesaplayıcı — CryptoCalk',
    ...
    'airdrop-calculator': {
      title: 'Airdrop Değer Hesaplayıcı — CryptoCalk',
    ...
    'satoshi-converter': {
      title: 'Satoshi Dönüştürücü — CryptoCalk',
    ...
    'gwei-converter': {
      title: 'Gwei Dönüştürücü — CryptoCalk',
    ...
    'timestamp-converter': {
      title: 'Unix Zaman Damgası Dönüştürücü — CryptoCalk',
    ...
    'unit-converter': {
      title: 'Kripto Birim Dönüştürücü — CryptoCalk',
    ...
    'exchange-fees': {
      title: 'Borsa Ücret Karşılaştırıcı — CryptoCalk',
    ...
    'crypto-loan-calculator': {
      title: 'Kripto Kredi Hesaplayıcı — CryptoCalk',
    ...
    'vesting-calculator': {
      title: 'Token Hak Ediş Hesaplayıcı — CryptoCalk',
    ...
    'nft-profit-calculator': {
      title: 'NFT Kar Hesaplayıcı — CryptoCalk',
    ...
    'halving-calculator': {
      title: 'Bitcoin Halving Hesaplayıcı — CryptoCalk',
    ...
    'mev-calculator': {
      title: 'MEV Koruma Hesaplayıcı — CryptoCalk',
    ...
    'gamefi-calculator': {
      title: 'GameFi ROI Hesaplayıcı — CryptoCalk',
    ...
    'node-calculator': {
      title: 'Doğrulayıcı Düğüm Hesaplayıcı — CryptoCalk',
    ...
    'salary-calculator': {
      title: 'Kripto Maaş Hesaplayıcı — CryptoCalk',
    ...
    'inflation-hedge': {
      title: 'Enflasyon Koruması Hesaplayıcı — CryptoCalk',
  ...
  'hi': {
    'converter': {
      title: 'क्रिप्टो कनवर्टर — CryptoCalk',
    ...
    'profit-calculator': {
      title: 'क्रिप्टो प्रॉफिट कैलकुलेटर — CryptoCalk',
    ...
    'mining-calculator': {
      title: 'बिटकॉइन माइनिंग कैलकुलेटर — CryptoCalk',
    ...
    'dca-calculator': {
      title: 'DCA कैलकुलेटर — CryptoCalk',
    ...
    'tax-calculator': {
      title: 'क्रिप्टो टैक्स कैलकुलेटर — CryptoCalk',
    ...
    'what-if': {
      title: 'व्हाट इफ कैलकुलेटर — CryptoCalk',
    ...
    'position-size-calculator': {
      title: 'पोज़िशन साइज़ कैलकुलेटर — CryptoCalk',
    ...
    'liquidation-calculator': {
      title: 'लिक्विडेशन कैलकुलेटर — CryptoCalk',
    ...
    'margin-calculator': {
      title: 'मार्जिन कैलकुलेटर — CryptoCalk',
    ...
    'pip-calculator': {
      title: 'पिप वैल्यू कैलकुलेटर — CryptoCalk',
    ...
    'break-even-calculator': {
      title: 'ब्रेक-ईवन कैलकुलेटर — CryptoCalk',
    ...
    'risk-reward-calculator': {
      title: 'रिस्क रिवॉर्ड कैलकुलेटर — CryptoCalk',
    ...
    'staking-calculator': {
      title: 'क्रिप्टो स्टेकिंग कैलकुलेटर — CryptoCalk',
    ...
    'impermanent-loss-calculator': {
      title: 'इम्परमानेंट लॉस कैलकुलेटर — CryptoCalk',
    ...
    'apy-apr-calculator': {
      title: 'APY vs APR कैलकुलेटर — CryptoCalk',
    ...
    'yield-farming-calculator': {
      title: 'यील्ड फार्मिंग कैलकुलेटर — CryptoCalk',
    ...
    'gas-calculator': {
      title: 'क्रिप्टो गैस कैलकुलेटर — CryptoCalk',
    ...
    'uniswap-calculator': {
      title: 'यूनिस्वैप फीस कैलकुलेटर — CryptoCalk',
    ...
    'bridge-comparator': {
      title: 'ब्रिज कॉस्ट तुलनित्र — CryptoCalk',
    ...
    'lending-calculator': {
      title: 'क्रिप्टो लेंडिंग कैलकुलेटर — CryptoCalk',
    ...
    'gpu-mining-calculator': {
      title: 'GPU माइनिंग कैलकुलेटर — CryptoCalk',
    ...
    'asic-mining-calculator': {
      title: 'ASIC माइनिंग कैलकुलेटर — CryptoCalk',
    ...
    'mining-roi-calculator': {
      title: 'माइनिंग ROI कैलकुलेटर — CryptoCalk',
    ...
    'electricity-cost-calculator': {
      title: 'माइनिंग बिजली लागत कैलकुलेटर — CryptoCalk',
    ...
    'difficulty-calculator': {
      title: 'माइनिंग कठिनाई अनुमानक — CryptoCalk',
    ...
    'hashrate-converter': {
      title: 'हैशरेट कनवर्टर — CryptoCalk',
    ...
    'market-cap-calculator': {
      title: 'मार्केट कैप कैलकुलेटर — CryptoCalk',
    ...
    'market-cap-comparator': {
      title: 'मार्केट कैप तुलनित्र — CryptoCalk',
    ...
    'roi-calculator': {
      title: 'ROI कैलकुलेटर — CryptoCalk',
    ...
    'reverse-roi': {
      title: 'रिवर्स ROI कैलकुलेटर — CryptoCalk',
    ...
    'hodl-vs-trade': {
      title: 'HODL बनाम ट्रेड कैलकुलेटर — CryptoCalk',
    ...
    'rebalancing-calculator': {
      title: 'पोर्टफोलियो रीबैलेंसिंग कैलकुलेटर — CryptoCalk',
    ...
    'compound-calculator': {
      title: 'चक्रवृद्धि ब्याज कैलकुलेटर (क्रिप्टो) — CryptoCalk',
    ...
    'ico-roi-calculator': {
      title: 'ICO / IDO ROI कैलकुलेटर — CryptoCalk',
    ...
    'airdrop-calculator': {
      title: 'एयरड्रॉप वैल्यू कैलकुलेटर — CryptoCalk',
    ...
    'satoshi-converter': {
      title: 'सातोशी कनवर्टर — CryptoCalk',
    ...
    'gwei-converter': {
      title: 'ग्वेई कनवर्टर — CryptoCalk',
    ...
    'timestamp-converter': {
      title: 'यूनिक्स टाइमस्टैम्प कनवर्टर — CryptoCalk',
    ...
    'unit-converter': {
      title: 'क्रिप्टो यूनिट कनवर्टर — CryptoCalk',
    ...
    'exchange-fees': {
      title: 'एक्सचेंज फीस तुलनित्र — CryptoCalk',
    ...
    'crypto-loan-calculator': {
      title: 'क्रिप्टो लोन कैलकुलेटर — CryptoCalk',
    ...
    'vesting-calculator': {
      title: 'टोकन वेस्टिंग कैलकुलेटर — CryptoCalk',
    ...
    'nft-profit-calculator': {
      title: 'NFT प्रॉफिट कैलकुलेटर — CryptoCalk',
    ...
    'halving-calculator': {
      title: 'बिटकॉइन हाल्विंग कैलकुलेटर — CryptoCalk',
    ...
    'mev-calculator': {
      title: 'MEV प्रोटेक्शन कैलकुलेटर — CryptoCalk',
    ...
    'gamefi-calculator': {
      title: 'गेमफाई ROI कैलकुलेटर — CryptoCalk',
    ...
    'node-calculator': {
      title: 'वैलिडेटर नोड कैलकुलेटर — CryptoCalk',
    ...
    'salary-calculator': {
      title: 'क्रिप्टो सैलरी कैलकुलेटर — CryptoCalk',
    ...
    'inflation-hedge': {
      title: 'मुद्रास्फीति बचाव कैलकुलेटर — CryptoCalk',
  ...
  'ru': {
    'converter': {
      title: 'Конвертер криптовалют — CryptoCalk',
    ...
    'profit-calculator': {
      title: 'Калькулятор прибыли криптовалют — CryptoCalk',
    ...
    'mining-calculator': {
      title: 'Калькулятор майнинга биткоина — CryptoCalk',
    ...
    'dca-calculator': {
      title: 'Калькулятор DCA — CryptoCalk',
    ...
    'tax-calculator': {
      title: 'Калькулятор налогов на криптовалюту — CryptoCalk',
    ...
    'what-if': {
      title: 'Калькулятор Если бы — CryptoCalk',
    ...
    'position-size-calculator': {
      title: 'Калькулятор размера позиции — CryptoCalk',
    ...
    'liquidation-calculator': {
      title: 'Калькулятор ликвидации — CryptoCalk',
    ...
    'funding-rate-calculator': {
      title: 'Калькулятор ставки фондирования — CryptoCalk',
    ...
    'tp-sl-calculator': {
      title: 'Калькулятор Тейк-Профит / Стоп-Лосс — CryptoCalk',
    ...
    'margin-calculator': {
      title: 'Калькулятор маржи — CryptoCalk',
    ...
    'pip-calculator': {
      title: 'Калькулятор стоимости пункта (Пип/Тик) — CryptoCalk',
    ...
    'break-even-calculator': {
      title: 'Калькулятор безубыточности — CryptoCalk',
    ...
    'risk-reward-calculator': {
      title: 'Калькулятор соотношения риска и прибыли — CryptoCalk',
    ...
    'staking-calculator': {
      title: 'Калькулятор стейкинга — CryptoCalk',
    ...
    'impermanent-loss-calculator': {
      title: 'Калькулятор непостоянных потерь — CryptoCalk',
    ...
    'apy-apr-calculator': {
      title: 'Калькулятор APY и APR — CryptoCalk',
    ...
    'yield-farming-calculator': {
      title: 'Калькулятор фарминга доходности — CryptoCalk',
    ...
    'gas-calculator': {
      title: 'Калькулятор газа криптовалют — CryptoCalk',
    ...
    'uniswap-calculator': {
      title: 'Калькулятор комиссий Uniswap — CryptoCalk',
    ...
    'bridge-comparator': {
      title: 'Сравнение стоимости мостов (Bridge) — CryptoCalk',
    ...
    'lending-calculator': {
      title: 'Калькулятор крипто-кредитования (Лендинг) — CryptoCalk',
    ...
    'gpu-mining-calculator': {
      title: 'Калькулятор майнинга на видеокартах (GPU) — CryptoCalk',
    ...
    'asic-mining-calculator': {
      title: 'Калькулятор ASIC-майнинга — CryptoCalk',
    ...
    'mining-roi-calculator': {
      title: 'Калькулятор окупаемости майнинга (ROI) — CryptoCalk',
    ...
    'electricity-cost-calculator': {
      title: 'Калькулятор стоимости электроэнергии для майнинга — CryptoCalk',
    ...
    'difficulty-calculator': {
      title: 'Калькулятор сложности майнинга — CryptoCalk',
    ...
    'hashrate-converter': {
      title: 'Конвертер хешрейта — CryptoCalk',
    ...
    'market-cap-calculator': {
      title: 'Калькулятор рыночной капитализации — CryptoCalk',
    ...
    'market-cap-comparator': {
      title: 'Сравнение рыночной капитализации — CryptoCalk',
    ...
    'roi-calculator': {
      title: 'Калькулятор ROI (рентабельности) — CryptoCalk',
    ...
    'reverse-roi': {
      title: 'Калькулятор обратного ROI — CryptoCalk',
    ...
    'hodl-vs-trade': {
      title: 'Калькулятор HODL vs Трейдинг — CryptoCalk',
    ...
    'rebalancing-calculator': {
      title: 'Калькулятор ребалансировки портфеля — CryptoCalk',
    ...
    'compound-calculator': {
      title: 'Калькулятор сложного процента (Крипто) — CryptoCalk',
    ...
    'ico-roi-calculator': {
      title: 'Калькулятор ROI для ICO / IDO — CryptoCalk',
    ...
    'airdrop-calculator': {
      title: 'Калькулятор стоимости аирдропа — CryptoCalk',
    ...
    'satoshi-converter': {
      title: 'Конвертер сатоши — CryptoCalk',
    ...
    'gwei-converter': {
      title: 'Конвертер Gwei — CryptoCalk',
    ...
    'timestamp-converter': {
      title: 'Конвертер Unix времени (Timestamp) — CryptoCalk',
    ...
    'unit-converter': {
      title: 'Конвертер крипто-единиц — CryptoCalk',
    ...
    'exchange-fees': {
      title: 'Сравнение комиссий бирж — CryptoCalk',
    ...
    'crypto-loan-calculator': {
      title: 'Калькулятор крипто-ссуд — CryptoCalk',
    ...
    'vesting-calculator': {
      title: 'Калькулятор вестинга токенов — CryptoCalk',
    ...
    'nft-profit-calculator': {
      title: 'Калькулятор прибыли NFT — CryptoCalk',
    ...
    'halving-calculator': {
      title: 'Калькулятор халвинга биткоина — CryptoCalk',
    ...
    'mev-calculator': {
      title: 'Калькулятор защиты от MEV — CryptoCalk',
    ...
    'gamefi-calculator': {
      title: 'Калькулятор ROI в GameFi — CryptoCalk',
    ...
    'node-calculator': {
      title: 'Калькулятор валидаторной ноды — CryptoCalk',
    ...
    'salary-calculator': {
      title: 'Калькулятор зарплаты в криптовалюте — CryptoCalk',
    ...
    'inflation-hedge': {
      title: 'Калькулятор хеджирования инфляции — CryptoCalk',
