    ...
    const fetchRate = useCallback(async () => {
        ...
        try {
            const res = await fetch(
                `https://api.coingecko.com/api/v3/simple/price?ids=${fromCoin.id}&vs_currencies=${toCurrency.id}&include_24hr_change=true&x_cg_demo_api_key=REMOVED_COINGECKO_KEY`
            );
