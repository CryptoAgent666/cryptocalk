...
const CATEGORY_CONFIGS: CategoryConfig[] = [
  {
    ...
    tools: [
      ...
      { name: 'If I Had Bought', href: '/if-i-had-bought/' },
      { name: 'Pizza Day Calculator', href: '/pizza-day-calculator/' },
    ],
  },
  {
    slug: 'converters',
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Tax Loss Harvesting', href: '/tax-loss-harvesting-calculator/' },
      { name: 'Inheritance Tax Calculator', href: '/inheritance-tax-calculator/' },
    ],
  },
  {
    slug: 'investment',
    ...
    tools: [
      ...
      { name: 'What If Calculator', href: '/what-if', translationKey: 'whatIfCalculator' },
      { name: 'Stock-to-Flow Calculator', href: '/stock-to-flow-calculator/' },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Arbitrage Calculator', href: '/arbitrage-calculator/' },
      { name: 'Options Calculator', href: '/options-calculator/' },
...
const TOOL_NAME_OVERRIDES: Partial<Record<Lang, Record<string, string>>> = {
  es: {
    ...
    'pizza-day-calculator': 'Calculadora Día Pizza',
    'bitcoin-energy-calculator': 'Calculadora Energía Bitcoin',
    'restaking-calculator': 'Calculadora Restaking',
    'liquid-staking-calculator': 'Staking Líquido',
    'validator-calculator': 'Economía del Validador',
    'tax-loss-harvesting-calculator': 'Cosecha Pérdidas Fiscales',
    'inheritance-tax-calculator': 'Impuesto de Herencia',
    'stock-to-flow-calculator': 'Stock-to-Flow Bitcoin',
    'payback-period-calculator': 'Período de Recuperación',
    'dva-calculator': 'Calculadora DVA',
    'token-valuation-calculator': 'Valoración de Token',
    'millionaire-calculator': 'Calculadora Millonario',
    'arbitrage-calculator': 'Calculadora Arbitraje',
    'options-calculator': 'Calculadora Opciones',
  ...
  pt: {
    ...
    'pizza-day-calculator': 'Calculadora Dia Pizza',
    'bitcoin-energy-calculator': 'Calculadora Energia Bitcoin',
    'restaking-calculator': 'Calculadora Restaking',
    'liquid-staking-calculator': 'Staking Líquido',
    'validator-calculator': 'Economia do Validador',
    'tax-loss-harvesting-calculator': 'Colheita de Prejuízos',
    'inheritance-tax-calculator': 'Imposto de Herança',
    'stock-to-flow-calculator': 'Stock-to-Flow Bitcoin',
    'payback-period-calculator': 'Período de Retorno',
    'dva-calculator': 'Calculadora DVA',
    'token-valuation-calculator': 'Avaliação de Token',
    'millionaire-calculator': 'Calculadora Milionário',
    'arbitrage-calculator': 'Calculadora Arbitragem',
    'options-calculator': 'Calculadora Opções',
  ...
  tr: {
    ...
    'if-i-had-bought': 'Eğer Alsaydım',
    'pizza-day-calculator': 'Pizza Günü Hesaplayıcı',
    'bitcoin-energy-calculator': 'Bitcoin Enerji Hesaplayıcı',
    'restaking-calculator': 'Restaking Hesaplayıcı',
    'liquid-staking-calculator': 'Likit Staking',
    'validator-calculator': 'Validatör Ekonomisi',
    'tax-loss-harvesting-calculator': 'Vergi Zarar Hasatlama',
    'inheritance-tax-calculator': 'Miras Vergisi',
    'stock-to-flow-calculator': 'Stock-to-Flow',
    'payback-period-calculator': 'Geri Ödeme Süresi',
    'dva-calculator': 'DVA Hesaplayıcı',
    'token-valuation-calculator': 'Token Değerleme',
    'millionaire-calculator': 'Milyoner Hesaplayıcı',
    'arbitrage-calculator': 'Arbitraj Hesaplayıcı',
    'options-calculator': 'Opsiyon Hesaplayıcı',
  ...
  hi: {
    ...
    'if-i-had-bought': 'अगर मैंने खरीदा होता',
    'pizza-day-calculator': 'पिज्जा डे कैलकुलेटर',
    'bitcoin-energy-calculator': 'बिटकॉइन एनर्जी',
    'restaking-calculator': 'रीस्टेकिंग कैलकुलेटर',
    'liquid-staking-calculator': 'लिक्विड स्टेकिंग',
    'validator-calculator': 'वैलिडेटर इकोनॉमिक्स',
    'tax-loss-harvesting-calculator': 'टैक्स लॉस हार्वेस्टिंग',
    'inheritance-tax-calculator': 'विरासत कर कैलकुलेटर',
    'stock-to-flow-calculator': 'स्टॉक-टू-फ्लो',
    'payback-period-calculator': 'पेबैक पीरियड',
    'dva-calculator': 'DVA कैलकुलेटर',
    'token-valuation-calculator': 'टोकन वैल्यूएशन',
    'millionaire-calculator': 'करोड़पति कैलकुलेटर',
    'arbitrage-calculator': 'आर्बिट्राज कैलकुलेटर',
    'options-calculator': 'ऑप्शन कैलकुलेटर',
  ...
  ru: {
    ...
    'if-i-had-bought': 'Если бы я купил',
    'pizza-day-calculator': 'Калькулятор дня пиццы',
    'bitcoin-energy-calculator': 'Энергия Bitcoin',
    'restaking-calculator': 'Калькулятор рестейкинга',
    'liquid-staking-calculator': 'Ликвидный стейкинг',
    'validator-calculator': 'Экономика валидатора',
    'tax-loss-harvesting-calculator': 'Сбор налоговых убытков',
    'inheritance-tax-calculator': 'Налог на наследство',
    'stock-to-flow-calculator': 'Stock-to-Flow Bitcoin',
    'payback-period-calculator': 'Срок окупаемости',
    'dva-calculator': 'Калькулятор DVA',
    'token-valuation-calculator': 'Оценка токена',
    'millionaire-calculator': 'Калькулятор миллионера',
    'arbitrage-calculator': 'Калькулятор арбитража',
    'options-calculator': 'Калькулятор опционов',
